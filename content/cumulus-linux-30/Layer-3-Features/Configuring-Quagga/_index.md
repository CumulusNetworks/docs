...
Daemons](/cumulus-linux-30/System-Management/Managing-Application-Daemons).
...
interfaces using Quagga. For more information, see [Configuring IP Addresses](/cumulus-linux-30/Configuring-and-Managing-Network-Interfaces/#configuring-ip-addresses)
and [Virtual Routing and Forwarding - VRF](/cumulus-linux-30/Layer-3-Features/Virtual-Routing-and-Forwarding-VRF).
...
commands](/cumulus-linux-30/Layer-3-Features/Configuring-Quagga/Cumulus-Linux-Quagga-Commands)
instead.
