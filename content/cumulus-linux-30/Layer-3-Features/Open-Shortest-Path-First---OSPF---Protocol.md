...
Protocols](/cumulus-linux-30/Layer-3-Features/Introduction-to-Routing-Protocols),
...
## Useful Links</span>
  ...
  - [Bidirectional forwarding detection](/cumulus-linux-30/Layer-3-Features/Bidirectional-Forwarding-Detection-BFD)
 (BFD) and OSPF
