...
[Spanning Tree](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Spanning-Tree-and-Rapid-Spanning-Tree).
...
## Caveats and Errata</span>
  ...
  - **<span id="src-5122017_VLAN-awareBridgeModeforLarge-scaleLayer2Environments-range"></span>Reserved
    ...
    2.  [Restart `switchd`](/cumulus-linux-31/System-Management/Configuring-switchd/#span-id-src-5121932-configuringswitchd-restartswitchd-class-confluence-anchor-link-span-restarting-switchd-span)
        ...
        forwarding will be
        [interrupted](/cumulus-linux-31/System-Management/Configuring-switchd/#span-id-src-5121932-configuringswitchd-restartswitchd-class-confluence-anchor-link-span-restarting-switchd-span#src-5121932_Configuringswitchd-restartswitchd).
  ...
  - **VLAN translation:** A bridge in VLAN-aware mode cannot have VLAN
    ...
    mode](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/)
