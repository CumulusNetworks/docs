...
[spanning
tree](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Spanning-Tree-and-Rapid-Spanning-Tree)
...
<p>For more information on spanning-tree configurations see the configuration section: <a href="/cumulus-linux-31/Layer-1-and-Layer-2-Features/Spanning-Tree-and-Rapid-Spanning-Tree">Spanning Tree and Rapid Spanning Tree</a>.</p></td>
</tr>
</tbody>
</table>
...
## <span id="src-5122007_EthernetBridging-VLANs-VLAN_tagging" class="confluence-anchor-link"></span>Using Trunks in Traditional Bridging Mode</span>
...
chapter](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-Tagging).
