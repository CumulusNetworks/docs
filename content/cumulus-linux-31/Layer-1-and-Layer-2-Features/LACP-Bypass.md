...
Keep in the mind the following caveats with all-active mode:
  ...
  - Spanning tree protocol (STP) does not run on the individual bond
    ...
    Cumulus Networks highly recommends you configure [STP BPDU guard](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Spanning-Tree-and-Rapid-Spanning-Tree/#span-id-src-5122089-spanningtreeandrapidspanningtree-bpdu-class-confluence-anchor-link-span-bpdu-guard-span)
...
In an [MLAG
deployment](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Multi-Chassis-Link-Aggregation-MLAG)
...
[VLAN-aware
mode](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments):
