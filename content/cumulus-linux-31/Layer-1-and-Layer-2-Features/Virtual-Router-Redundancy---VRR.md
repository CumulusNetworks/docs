...
configured with
[MLAG](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Multi-Chassis-Link-Aggregation-MLAG),
...
Interfaces](/cumulus-linux-31/Configuring-and-Managing-Network-Interfaces/).
...
bridges](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments).
