...
### <span id="src-5122145_VirtualRoutingandForwarding-VRF-vrf_cmd" class="confluence-anchor-link"></span>Using the vrf Command</span>
...
[Quagga](/cumulus-linux-31/Layer-3-Features/Quagga-Overview)
...
[BFD](/cumulus-linux-31/Layer-3-Features/Bidirectional-Forwarding-Detection-BFD),
...
configurations](/cumulus-linux-31/Layer-3-Features/Border-Gateway-Protocol-BGP)
