...
multiple routes are installed by default. See the [ECMP section](/cumulus-linux-321/Layer-Three/Border-Gateway-Protocol-BGP/#span-id-src-5127049-bordergatewayprotocol-bgp-ecmp-class-confluence-anchor-link-span-ecmp-with-bgp-span)
...
### Configuring Resilient Hashing</span>
...
3.  [Restart](/cumulus-linux-321/System-Configuration/Configuring-switchd/#span-id-src-5126758-configuringswitchd-restartswitchd-class-confluence-anchor-link-span-restarting-switchd-span#src-5126758_Configuringswitchd-restartswitchd)
    the `switchd` service:
