...
the following:
  ...
  - Open Shortest Path First
    ([v2](/cumulus-linux-321/Layer-Three/Open-Shortest-Path-First-OSPF-Protocol)
    and
    [v3](/cumulus-linux-321/Layer-Three/Open-Shortest-Path-First-v3-OSPFv3-Protocol))

  - [Border Gateway
    Protocol](/cumulus-linux-321/Layer-Three/Border-Gateway-Protocol-BGP)
