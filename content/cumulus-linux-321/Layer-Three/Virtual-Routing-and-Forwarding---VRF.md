...
interfaces. Keep in mind the following for a VRF table:
  ...
  - Names for VRF tables can be up to 15 characters. However, you
    **cannot** use the name *mgmt*, as this name can **only** be used
    for [management
    VRF](/cumulus-linux-321/Layer-Three/Management-VRF).
...
[Quagga](/cumulus-linux-321/Layer-Three/Quagga-Overview) learns
...
configurations](/cumulus-linux-321/Layer-Three/Border-Gateway-Protocol-BGP)
...
## Caveats and Errata</span>
  ...
  - You cannot configure [EVPN address
    families](/cumulus-linux-321/Network-Virtualization/Ethernet-Virtual-Private-Network-EVPN)
    within a VRF.
