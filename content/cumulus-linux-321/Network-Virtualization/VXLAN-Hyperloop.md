...
## VXLAN Routing and Hyperloop Troubleshooting Matrix</span>
  ...
  - **Are you running the newest code?** This guide and testing was done
    ...
    Linux
    system. ](/cumulus-linux-321/Installation-Management/Managing-Cumulus-Linux-Disk-Images/Upgrading-Cumulus-Linux)
    ...
    or use
    [NCLU](/cumulus-linux-321/Layer-Three/Configuring-Quagga/Comparing-NCLU-and-vtysh-Commands):
  ...
  - **If you are using EVPN are you using the correct Quagga
    ...
    the directions
    here](/cumulus-linux-321/Network-Virtualization/Ethernet-Virtual-Private-Network-EVPN).
  ...
  - **Is the VRR MAC address unique per subnet?**  
    ...
    correctly](/cumulus-linux-321/Layer-One-and-Two/Virtual-Router-Redundancy-VRR/) and that
