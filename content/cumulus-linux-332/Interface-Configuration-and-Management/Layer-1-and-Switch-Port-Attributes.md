...
with one exception - you only need to configure is [MTU](#mtu). You don't 
even need to enable auto-negotation, as the Mellanox firmware configures
everything for you.
...
the settings as described in the 
...
(see the [table below](#default-interface-configuration-settings)). FEC 
always adjusts for the speed of the cable. However, you **cannot** disable 
FEC separately using
[NCLU](/cumulus-linux-332/System-Configuration/Network-Command-Line-Utility).
...
[VXLANs](/cumulus-linux-332/Network-Virtualization/), the MTU
...
[interrupts network services](/cumulus-linux-332/System-Configuration/Configuring-switchd/#span-id-src-5868885-configuringswitchd-restartswitchd-class-confluence-anchor-link-span-restarting-switchd-span).
...
way. See [the note](#configuring-breakout-ports) above.
...
`switchd`](/cumulus-linux-332/System-Configuration/Configuring-switchd/#span-id-src-5868885-configuringswitchd-restartswitchd-class-confluence-anchor-link-span-restarting-switchd-span)
