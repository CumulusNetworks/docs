...
[LACP Bypass](/cumulus-linux-332/Layer-One-and-Two/LACP-Bypass).
...
<td><p>Enables <a href="/cumulus-linux-332/Layer-One-and-Two/LACP-Bypass">LACP bypass</a>.</p></td>
<td><p>N/A</p></td>
</tr>
<tr class="odd">
<td><p><code>bond lacp-rate</code></p></td>
<td><p>Sets the rate to ask the link partner to transmit LACP control packets.</p>
<p>You can set the LACP rate to slow using <a href="/cumulus-linux-332/System-Configuration/Network-Command-Line-Utility">NCLU</a>:</p>
