...
Keep in the mind the following caveats with all-active mode:
  ...
  - Spanning tree protocol (STP) does not run on the individual bond
    ...
    [STP BPDU guard](/cumulus-linux-332/Layer-One-and-Two/Spanning-Tree-and-Rapid-Spanning-Tree/#bpdu-guard)
...
In an [MLAG deployment](/cumulus-linux-332/Layer-One-and-Two/Multi-Chassis-Link-Aggregation-MLAG)
...
[traditional bridge mode](/cumulus-linux-332/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges):
