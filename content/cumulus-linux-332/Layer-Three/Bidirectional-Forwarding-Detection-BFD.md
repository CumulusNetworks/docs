...
the [PTM `topology.dot` file](/cumulus-linux-332/Layer-One-and-Two/Prescriptive-Topology-Manager-PTM),
or using
[Quagga](/cumulus-linux-332/Layer-Three/Quagga-Overview).
...
that file. Use
[Quagga](/cumulus-linux-332/Layer-Three/Configuring-Quagga/) to
...
de-registered with
[PTM](/cumulus-linux-332/Layer-One-and-Two/Prescriptive-Topology-Manager-PTM)
...
[Prescriptive Topology Manager - PTM](/cumulus-linux-332/Layer-One-and-Two/Prescriptive-Topology-Manager-PTM).
