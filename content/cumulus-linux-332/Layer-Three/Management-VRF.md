...
If you're using
[sFlow](/cumulus-linux-332/Monitoring-and-Troubleshooting/Network-Troubleshooting/Monitoring-System-Statistics-and-Network-Traffic-with-sFlow/)
...
you need to SSH from the device out of a switch port, use 
...
In `ifupdown2` [interface classes](/cumulus-linux-332/Interface-Configuration-and-Management/#ifupdown2-interface-classes)
