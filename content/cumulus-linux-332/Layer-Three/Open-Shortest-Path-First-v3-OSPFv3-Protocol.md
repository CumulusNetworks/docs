...
[Open Shortest Path First (OSPF) Protocol](/cumulus-linux-332/Layer-Three/Open-Shortest-Path-First-OSPF-Protocol)
...
[Quagga](/cumulus-linux-332/Layer-Three/Quagga-Overview) does
not support it yet.
...
1.  Enabling the `zebra` and `ospf6` daemons, as described in
    [Configuring Quagga](/cumulus-linux-332/Layer-Three/Configuring-Quagga/)
...
See [Debugging OSPF](/cumulus-linux-332/Layer-Three/Open-Shortest-Path-First-OSPF-Protocol/#debugging-ospf)
