...
interfaces. Keep in mind the following for a VRF table:
  ...
  - Names for VRF tables can be up to 15 characters. However, you
    **cannot** use the name *mgmt*, as this name can **only** be used
    for [management VRF](/cumulus-linux-332/Layer-Three/Management-VRF).
...
[Quagga](/cumulus-linux-332/Layer-Three/Quagga-Overview) learns
...
[BFD](/cumulus-linux-332/Layer-Three/Bidirectional-Forwarding-Detection-BFD),
...
[BGP unnumbered interface configurations](/cumulus-linux-332/Layer-Three/Border-Gateway-Protocol-BGP/#using-bgp-unnumbered-interfaces)
...
## Caveats and Errata
  ...
  - You cannot configure [EVPN address families](/cumulus-linux-332/Network-Virtualization/Ethernet-Virtual-Private-Network-EVPN)
    within a VRF.
