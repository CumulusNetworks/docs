...
[VXLANs](/cumulus-linux-332/Network-Virtualization/) in Cumulus
Linux, with the following functionality:
  ...
  - Support for dual-attached hosts via 
    [VXLAN active-active mode](/cumulus-linux-332/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode);
...
For a bridge in [traditional mode](/cumulus-linux-332/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges),
...
mode](/cumulus-linux-332/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges),
you must edit the bridge configuration in the `/etc/network/interfaces`
file in a text editor:
...
[Head End Replication (HER)](/cumulus-linux-332/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/#head-end-replication).
HER is enabled by default, as it is when 
[Lightweight Network Virtualization (LNV)](/cumulus-linux-332/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/)
is used.
...
iface vxlan10200
     ...
     vxlan-local-tunnelip 10.0.0.11
     bridge-access 200
     bridge-learning off</code></pre></details></td>
<td><details>
...
auto swp4
iface swp4</code></pre></details></td>
<td><details>
...
active-active
mode](/cumulus-linux-332/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode).
...
The active-active configuration should include the following:
  ...
  - The `clagd-vxlan-anycast-ip` parameter must be under the 
    [loopback stanza](/cumulus-linux-332/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode/#active-active-vtep-anycast-ip-behavior)
    on both peers
  - The anycast address should be advertised to the routed fabric from
    both peers
  - The [VNIs](/cumulus-linux-332/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode/#example-vxlan-active-active-configuration)
    must be configured identically on both peers
  - The [peerlink](/cumulus-linux-332/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode/#example-vxlan-active-active-configuration)
