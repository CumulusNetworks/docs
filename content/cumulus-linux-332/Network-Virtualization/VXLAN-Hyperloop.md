...
## Requirements
  ...
  - VXLAN hyperloop is supported on Cumulus Linux 3.2.1 and later. Make
    sure to [upgrade to the latest version](/cumulus-linux-332/Installation-Management/Upgrading-Cumulus-Linux)
    of Cumulus Linux.
  - If you are using
    [EVPN](/cumulus-linux-332/Network-Virtualization/Ethernet-Virtual-Private-Network-EVPN),
    ...
    [follow these directions](/cumulus-linux-332/Network-Virtualization/Ethernet-Virtual-Private-Network-EVPN)
    to upgrade.
...
or use
[NCLU](/cumulus-linux-332/Layer-Three/Configuring-Quagga/Comparing-NCLU-and-vtysh-Commands):
...
If you are not getting HER entries, there are some steps you can try:
  ...
  - Make sure you are using
    [LNV](/cumulus-linux-332/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/)
...
Make sure that [VRR is configured correctly](/cumulus-linux-332/Layer-One-and-Two/Virtual-Router-Redundancy-VRR/)
