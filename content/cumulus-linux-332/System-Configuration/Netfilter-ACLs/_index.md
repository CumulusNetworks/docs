...
3.  [Restart `switchd`](/cumulus-linux-332/System-Configuration/Configuring-switchd/#restarting-switchd):
...
and [traditional mode](/cumulus-linux-332/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges)
bridges, including bridge SVIs ([switch VLAN interfaces](/cumulus-linux-332/Layer-One-and-Two/Ethernet-Bridging-VLANs/#configuring-an-svi-switch-vlan-interface))
...
with the [TCAM profile](/cumulus-linux-332/Layer-Three/Routing/#tcam-resource-profiles-for-mellanox-switches) 
...
Then [restart `switchd`](/cumulus-linux-332/System-Configuration/Configuring-switchd/#restarting-switchd).
