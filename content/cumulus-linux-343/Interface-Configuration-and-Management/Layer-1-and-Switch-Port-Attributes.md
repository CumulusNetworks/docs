...
[table below](#interface-settings).
...
configuration settings specified in the [table below](#interface-settings).
...
the settings as described in the [default settings table below](#interface-settings).
...
(see the [table below](#interface-settings)). FEC always
...
[VXLANs](/cumulus-linux-343/Network-Virtualization/), the MTU
...
[interrupts network services](/cumulus-linux-343/System-Configuration/Configuring-switchd/#restarting-switchd).
...
to come up; however, this involves [restarting `switchd`](/cumulus-linux-343/System-Configuration/Configuring-switchd/#restarting-switchd)
