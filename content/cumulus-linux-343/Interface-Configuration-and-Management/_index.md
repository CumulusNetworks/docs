...
[Layer 1 and Switch Port Attributes](/cumulus-linux-343/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes).
...
link speed, and so
forth](/cumulus-linux-343/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes).
...
`ip address delete specify.ip.address.here/mask dev DEVICE`. See also the
...
[SNMP OID](/cumulus-linux-343/Monitoring-and-Troubleshooting/Monitoring-System-Hardware/#monitoring-switch-hardware-using-snmp)
