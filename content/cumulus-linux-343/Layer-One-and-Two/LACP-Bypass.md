...
- Spanning tree protocol (STP) does not run on the individual bond
  ...
  [STP BPDU guard](/cumulus-linux-343/Layer-One-and-Two/Spanning-Tree-and-Rapid-Spanning-Tree/#bpdu-guard)
...
In an [MLAG
deployment](/cumulus-linux-343/Layer-One-and-Two/Multi-Chassis-Link-Aggregation-MLAG)
