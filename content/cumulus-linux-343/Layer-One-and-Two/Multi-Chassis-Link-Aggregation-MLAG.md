...
MLAG has these requirements:
  ...
  - The dual-connected devices (servers or switches) can use LACP (IEEE
    ...
    [bond](/cumulus-linux-343/Layer-One-and-Two/Bonding-Link-Aggregation).
    In this case, the peer switches must also use LACP.
    
    {{%notice tip%}}
    
If for some reason you cannot use LACP, you can also use
[balance-xor mode](/cumulus-linux-343/Layer-One-and-Two/Bonding-Link-Aggregation/#enabling-balance-xor-mode)
...
configuration changes, including:
  ...
  - Port configuration: For example, VLAN membership,
    [MTU](/cumulus-linux-343/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes/#mtu) 
...
same bridged network, Cumulus Networks has 
...
interface up with `ifup`. Do **not** use
...
unnumbered](/cumulus-linux-343/Layer-Three/Border-Gateway-Protocol-BGP)
interfaces.
...
{{< figure src="/images/cumulus-linux/mlag_cfg.png" width="500" >}}
...
mode](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments).
...
[range of VLAN IDs you can use](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments/#reserved-vlan-range).
...
It's possible to configure MLAG with a bridge in 
[traditional mode](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges)
instead of
[VLAN-aware mode](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments).
...
[untagged/native](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges)
...
[VRF](/cumulus-linux-343/Layer-Three/Virtual-Routing-and-Forwarding-VRF)
or [management
VRF](/cumulus-linux-343/Layer-Three/Management-VRF). Include the
...
protocol such as
[VRR](/cumulus-linux-343/Layer-One-and-Two/Virtual-Router-Redundancy-VRR/)
...
[IGMP snooping](/cumulus-linux-343/Layer-One-and-Two/IGMP-and-MLD-Snooping)
...
[IGMP and MLD Snooping](/cumulus-linux-343/Layer-One-and-Two/IGMP-and-MLD-Snooping)
chapter.
...
Note that the
[MTU](/cumulus-linux-343/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes)
...
On all four leaf switches, 
[configure `mtu 9216`](/cumulus-linux-343/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes)
...
see [BPDU Guard](/cumulus-linux-343/Layer-One-and-Two/Spanning-Tree-and-Rapid-Spanning-Tree/#bpdu-guard).)
...
- The STP configuration for dual-connected ports should be the same on
    both peer switches.
- Use [NCLU](/cumulus-linux-343/System-Configuration/Network-Command-Line-Utility-NCLU)
...
You can detect this issue by running `net show counters` or
`ethtool -S <interface>`.
