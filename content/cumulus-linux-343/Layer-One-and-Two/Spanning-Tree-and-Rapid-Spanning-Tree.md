...
[traditional or VLAN-aware bridge driver mode](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/)
is in use.
...
For a bridge in [traditional mode](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/),
...
state is to manually un-shut or bring up the port with `sudo ifup  [port]`,
...
in this file after rebooting the switch, you must 
[restart `switchd`](/cumulus-linux-343/System-Configuration/Configuring-switchd/#restarting-switchd)
...
asterisk (\*). You can 
[edit the blacklist](/cumulus-linux-343/System-Configuration/Network-Command-Line-Utility-NCLU/#advanced-configuration)
...
<p>{{%notice note%}}</p>
<p>This setting only applies to a bridge in <a href="/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges">traditional mode</a>; it does not apply to <a href="/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments">VLAN-aware bridges</a>.</p>
<p>{{%/notice%}}</p></td>
</tr>
<tr class="even">
...
[Vitalii Demianets](mailto:vitas%40nppfactor.kiev.ua) and is hosted at the
sourceforge URL below.

- [Sourceforge - mstpd project](https://sourceforge.net/projects/mstpd/)
