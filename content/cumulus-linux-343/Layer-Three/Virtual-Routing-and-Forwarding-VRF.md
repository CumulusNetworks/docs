...
- Applications can use existing interfaces to operate in a VRF context - 
  ...
  [management VRF](/cumulus-linux-343/Layer-Three/Management-VRF) is
...
- Listen sockets used by services are VRF-global by default unless the
  ...
  read about 
  [services in the management VRF](/cumulus-linux-343/Layer-Three/Management-VRF/#running-services-within-the-management-vrf).
...
- Names for VRF tables can be up to 15 characters. However, you
  **cannot** use the name *mgmt*, as this name can **only** be used for
  [management VRF](/cumulus-linux-343/Layer-Three/Management-VRF).
...
[management VRF chapter](/cumulus-linux-343/Layer-Three/Management-VRF/#running-services-within-the-management-vrf) 
...
[BFD](/cumulus-linux-343/Layer-Three/Bidirectional-Forwarding-Detection-BFD),
...
[BGP unnumbered interface configurations](/cumulus-linux-343/Layer-Three/Border-Gateway-Protocol-BGP)
...
- You cannot configure [EVPN address
    families](/cumulus-linux-343/Network-Virtualization/Ethernet-Virtual-Private-Network-EVPN)
    within a VRF.
