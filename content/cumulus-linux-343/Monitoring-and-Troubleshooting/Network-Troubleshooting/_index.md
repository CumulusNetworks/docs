...
[Netfilter](/cumulus-linux-343/System-Configuration/Netfilter-ACLs/)
...
[same utility for security ACL configuration](/cumulus-linux-343/System-Configuration/Netfilter-ACLs/).
...
must enable 
[non-atomic update mode](/cumulus-linux-343/System-Configuration/Netfilter-ACLs/#enabling-nonatomic-update-mode).
...
[the `tcpdump` documentation](http://www.tcpdump.org/#documentation) and the 
