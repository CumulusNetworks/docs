...
When you configure [Management VRF](/cumulus-linux-343/Layer-Three/Management-VRF/), 
...
<tr class="odd">
<td><p><strong><a href="/cumulus-linux-343/Monitoring-and-Troubleshooting/SNMP-Monitoring/Using-Nutanix-Prism-as-a-Monitoring-Tool">Nutanix Prism CLI</a></strong> (SSH to the cluster IP address)</p></td>
...
<td><p>L2 neighbor info from <code>lldpd</code> (note, you need to <a href="/cumulus-linux-343/Layer-One-and-Two/Link-Layer-Discovery-Protocol/#enabling-the-snmp-subagent-in-lldp">enable the SNMP subagent</a> in LLDP). <code>lldpd</code> needs to be started with the <code>-x</code> option to enable connectivity to <code>snmpd</code> (AgentX).</p></td>
</tr>
<tr class="even">
...
- `cl_poe_pp.py` is disabled by default as only some platforms that
    ...
    Ethernet](/cumulus-linux-343/System-Configuration/Power-over-Ethernet-PoE).
