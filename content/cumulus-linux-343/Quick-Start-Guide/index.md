...
[Upgrading Cumulus Linux](/cumulus-linux-343/Installation-Management/Upgrading-Cumulus-Linux/)
...
[Using sudo to Delegate Privileges](/cumulus-linux-343/System-Configuration/Authentication-Authorization-and-Accounting/Using-sudo-to-Delegate-Privileges).

#### Serial Console Management

Users are encouraged to perform management and configuration over the network, 
[either in band or out of band](/cumulus-linux-343/Installation-Management/Upgrading-Cumulus-Linux/#out-of-band-management-is-worth-the-investment).
...
[correct the time](/cumulus-linux-343/System-Configuration/Setting-Date-and-Time)
...
[Layer 1 and Switch Port Attributes](/cumulus-linux-343/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes/#configuring-breakout-ports).
