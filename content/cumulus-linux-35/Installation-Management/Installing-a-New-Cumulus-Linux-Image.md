...
states:
  ...
  - The switch already has Cumulus Linux installed on it, so you only
    need to [upgrade it](/cumulus-linux-35/Installation-Management/Upgrading-Cumulus-Linux).
...
Make sure to [back
up](/cumulus-linux-35/Installation-Management/Upgrading-Cumulus-Linux)
...
[Upgrading Cumulus Linux](/cumulus-linux-35/Installation-Management/Upgrading-Cumulus-Linux/#upgrading-via-binary-install-onie).
