...
mode](/cumulus-linux-35/Layer-1-and-2/Ethernet-Bridging-VLANs/)
is in use.
...
asterisk (\*). You can 
[edit the blacklist](/cumulus-linux-35/System-Configuration/Network-Command-Line-Utility-NCLU/#advanced-configuration)
...
<p>{{%notice note%}}</p>
<p>This setting only applies to a bridge in <a href="/cumulus-linux-35/Layer-1-and-2/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges">traditional mode</a>; it does not apply to <a href="/cumulus-linux-35/Layer-1-and-2/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments">VLAN-aware bridges</a>.</p>
<p>{{%/notice%}}</p></td>
</tr>
<tr class="even">
