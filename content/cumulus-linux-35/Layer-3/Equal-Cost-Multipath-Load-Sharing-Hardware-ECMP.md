...
[ECMP section](/cumulus-linux-35/Layer-3/Border-Gateway-Protocol-BGP/#ecmp-with-bgp)
...
3.  [Restart](/cumulus-linux-35/System-Configuration/Configuring-switchd/#restarting-switchd)
    the `switchd` service:
