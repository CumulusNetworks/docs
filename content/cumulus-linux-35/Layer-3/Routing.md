...
You can use
[`cl-resource-query`](/cumulus-linux-35/Monitoring-and-Troubleshooting/Resource-Diagnostics-Using-cl-resource-query)
...
When [nonatomic updates](/cumulus-linux-35/System-Configuration/Netfilter-ACLs/#nonatomic-update-mode-vs-atomic-update-mode) are
