...
`cl-support`, read 
[Understanding the cl-support Output File](/cumulus-linux-35/Monitoring-and-Troubleshooting/Understanding-the-cl-support-Output-File/).
...
[Writing to syslog with Management VRF Enabled](#writing-to-syslog-with-management-vrf-enabled)
below.
...
| 20-clagd.conf     | Logs `clagd` messages to `/var/log/clagd.log` for [MLAG](/cumulus-linux-35/Layer-1-and-2/Multi-Chassis-Link-Aggregation-MLAG).                      |
...
| 30-ptmd.conf      | Logs `ptmd` messages to `/var/log/ptmd.log` for [Prescription Topology Manager](/cumulus-linux-35/Layer-1-and-2/Prescriptive-Topology-Manager-PTM). |
| 35-rdnbrd.conf    | Logs `rdnbrd` messages to `/var/log/rdnbrd.log` for [redistribute neighbor](/cumulus-linux-35/Layer-3/Redistribute-Neighbor).                         |
| 40-netd.conf      | Logs `netd` messages to `/var/log/netd.log` for [NCLU](/cumulus-linux-35/System-Configuration/Network-Command-Line-Utility-NCLU/).                  |
...
[Troubleshooting Log
Files](/cumulus-linux-35/Monitoring-and-Troubleshooting/Understanding-the-cl-support-Output-File/Troubleshooting-Log-Files).
...
[management VRF](/cumulus-linux-35/Layer-3/Management-VRF) enabled by
