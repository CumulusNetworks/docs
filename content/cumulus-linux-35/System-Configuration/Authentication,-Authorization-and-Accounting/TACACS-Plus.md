...
| -------- | -------------- |
| /etc/tacplus\_servers                   | This is the primary file that requires configuration post-installation, and is used by all packages via 
...
when a [management
VRF](/cumulus-linux-35/Layer-3/Management-VRF) is configured,
