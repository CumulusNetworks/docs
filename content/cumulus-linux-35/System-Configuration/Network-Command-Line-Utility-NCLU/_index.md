...
using:
  ...
  - `net commit permanent`: Retains the
    [snapshot](/cumulus-linux-35/Installation-Management/Using-Snapshots)
...
[TACACS](/cumulus-linux-35/System-Configuration/Authentication-Authorization-and-Accounting/TACACS-Plus)
or
...
to give edit permissions to the [*tacacs* group](/cumulus-linux-35/System-Configuration/Authentication-Authorization-and-Accounting/TACACS-Plus/#configuring-nclu-for-tacacs-users).
