...
[Switch Port Attributes](/cumulus-linux-36/Layer-1-and-Switch-Ports/Interface-Configuration-and-Management/Switch-Port-Attributes).
...
[Management VRF](/cumulus-linux-36/Layer-3/Management-VRF), you
...
[MTU, link speed, and so forth](/cumulus-linux-36/Layer-1-and-Switch-Ports/Interface-Configuration-and-Management/Switch-Port-Attributes).
...
OID
{{<mib_link text="IF-MIB::ifAlias" url="mibs/IF-MIB.txt" >}}.
