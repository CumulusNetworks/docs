...
the [PTM `topology.dot` file](/cumulus-linux-36/Layer-1-and-Switch-Ports/Prescriptive-Topology-Manager-PTM),
or using
...
that file. Use
[FRRouting](/cumulus-linux-36/Layer-3/Configuring-FRRouting/) to
...
de-registered with
[PTM](/cumulus-linux-36/Layer-1-and-Switch-Ports/Prescriptive-Topology-Manager-PTM)
