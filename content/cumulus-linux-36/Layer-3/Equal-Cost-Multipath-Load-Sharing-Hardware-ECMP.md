...
[ECMP section](/cumulus-linux-36/Layer-3/Border-Gateway-Protocol-BGP/#ecmp-with-bgp)
...
3.  [Restart](/cumulus-linux-36/System-Configuration/Configuring-switchd/#restarting-switchd)
    the `switchd` service:
