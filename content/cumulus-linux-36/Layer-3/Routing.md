...
You can use
[`cl-resource-query`](/cumulus-linux-36/Monitoring-and-Troubleshooting/Resource-Diagnostics-Using-cl-resource-query)
...
When [nonatomic updates](/cumulus-linux-36/System-Configuration/Netfilter-ACLs/#enabling-nonatomic-update-mode) are
