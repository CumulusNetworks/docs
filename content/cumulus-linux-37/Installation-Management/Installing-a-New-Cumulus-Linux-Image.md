...
pageID: 8362643
---
This topic discusses how to install a new Cumulus Linux disk image using {{<exlink url="https://opencomputeproject.github.io/onie/">}}, an open source project (equivalent to PXE on servers) that enables the installation of network operating systems (NOS) on bare metal switches.
