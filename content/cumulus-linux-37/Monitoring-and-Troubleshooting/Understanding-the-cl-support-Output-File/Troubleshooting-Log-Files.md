...
abstraction layer) from hardware like the {{<exlink url="https://cumulusnetworks.com/hcl" text="Broadcom or Mellanox Spectrum ASIC">}}.
...
<td><p>Logs output generated by running the {{<link url="Ethernet-Bridging-VLANs" text="my text">}}<a href="../../../Installation-Management/Zero-Touch-Provisioning-ZTP">zero touch provisioning</a> script.</p></td>
<td><p> </p></td>
</tr>
<tr class="even">
...
<td><p>Logs status of the {{<link url="Ethernet-Bridging-VLANs" text="my text">}}<a href="../../../Layer-2/Multi-Chassis-Link-Aggregation-MLAG"><code>clagd</code> service</a>.</p></td>
<td><p> </p></td>
</tr>
<tr class="odd">
...
<td><p>Log file for {{<link url="Ethernet-Bridging-VLANs" text="my text">}}<a href="../../../System-Configuration/Network-Command-Line-Utility-NCLU">NCLU</a>.</p></td>
<td><p> </p></td>
</tr>
<tr class="even">
...
<td><p>Logs for {{<link url="Ethernet-Bridging-VLANs" text="my text">}}<a href="../../../Layer-3/Redistribute-Neighbor">redistribute neighbor</a>.</p></td>
<td><p> </p></td>
</tr>
<tr class="odd">
<td><p>/var/log/snapper.log</p></td>
<td><p>Log file for {{<link url="Ethernet-Bridging-VLANs" text="my text">}}<a href="../../../Installation-Management/Using-Snapshots">snapshots</a>.</p></td>
