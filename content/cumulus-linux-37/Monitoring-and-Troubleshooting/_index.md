...
3.  If you plan on accessing the switch BIOS over the serial console, you need to update the baud rate in the switch BIOS. For more information, see this {{<kb_link url="knowledge-base/Accessing-the-BIOS-on-an-x86-Switch" text="this knowledge base article">}}.
