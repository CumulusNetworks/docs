...
- Head-end-replication of BUM traffic for remote VTEPs is only enabled for type-3 route advertisements that have a [PMSI Tunnel Attribute](https://tools.ietf.org/html/rfc6514#section-5) with the tunnel type set to Ingress Replication.
