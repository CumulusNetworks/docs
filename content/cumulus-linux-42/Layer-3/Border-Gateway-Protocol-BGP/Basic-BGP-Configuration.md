...
3. Specify the BGP neighbor to which you want to distribute routing information.
    ...
    ```
    cumulus@leaf01:~$ net add bgp neighbor 10.0.1.1 remote-as external
    ```
...
3. Specify the BGP neighbor to which you want to distribute routing information.
    ...
    ```
    cumulus@spine01:~$ net add bgp neighbor 10.0.1.0 remote-as external
    ```
...
3. Specify where to distribute routing information:
   ...
   ```
   leaf01(config-router)# neighbor 10.0.1.1 remote-as external
   ```
...
3. Specify where to distribute routing information:
    ...
    ```
    spine01(config-router)# neighbor 10.0.1.0 remote-as external
    ```
