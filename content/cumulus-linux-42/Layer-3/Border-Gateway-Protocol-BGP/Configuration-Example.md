...
toc: 3
---
This section shows a BGP configuration example based on the reference topology. The example configures BGP **unnumbered** on all leafs and spines and uses the peer group *underlay*.
