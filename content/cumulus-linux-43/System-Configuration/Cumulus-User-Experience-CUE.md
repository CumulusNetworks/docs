...
CUE is currently available for evaluation. Your feedback is welcome and appreciated as we start to roll out the new Cumulus Linux CLI. You can provide feedback and join the CUE discussion in the **#net-cl-cue-ea-feedback** Slack channel or send an email to net-cl-cue-ea-feedback@nvidia.com.
