...
- Cumulus Linux includes and enables the WJH agent by default so that you can stream detailed and contextual telemetry for off-switch analysis with tools, such as {{<kb_link latest="netq" text="NVIDIA NetQ">}}. 
