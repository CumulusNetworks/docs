...
This simulation starts with the {{<link url="#evpn-mh-with-head-end-replication" text="EVPN-MH with Head End Replication configuration">}}. The demo is pre-configured using {{<exlink url="https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-44/System-Configuration/NVIDIA-User-Experience-NVUE/" text="NVUE">}} commands.
