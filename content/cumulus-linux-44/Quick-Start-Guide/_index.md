...
2. {{<exlink url="https://enterprise-support.nvidia.com/s/downloads" text="Download">}} the Cumulus Linux installation file to the root directory of the web server. Rename this file `onie-installer`.
