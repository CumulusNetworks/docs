...
{{< /tab >}}
{{< tab "Try It " >}}
    {{< simulation name="Try It CL501 - EVPN Symmetric-v3" showNodes="leaf01,leaf02,leaf03,leaf04,spine01,spine02,spine03,spine04,border01,border02,fw1,server01,server02,server03,server04,server05,server06" >}}
