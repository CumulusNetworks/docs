...
- A specific software license key is no longer required to enable the `switchd` service. Refer to this {{<kb_link url="knowledge-base/Installing-and-Upgrading/Installation/Licensing-in-Cumulus-Linux-5.0-and-Later/" text="knowledge base article" >}}.
