...
- VNI membership exchange between [VTEPs](## "Virtual Tunnel End Points") using EVPN type-3 (Inclusive multicast Ethernet tag) routes.
...
- {{<link url="Basic-Configuration#arp-and-nd-suppression" text="ARP/ND suppression">}} is on VNIs by default, which enables VTEPs to suppress [ARP](## "Address Resolution Protocol") flooding over VXLAN tunnels.
