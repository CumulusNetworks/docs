...
Cumulus Linux 5.1 includes the NVIDIA Cumulus NetQ agent and CLI. You can use Cumulus NetQ to monitor and manage your data center network infrastructure and operational health. Refer to the [NVIDIA Cumulus NetQ documentation]({{<ref "/cumulus-netq-41" >}}) for details.
