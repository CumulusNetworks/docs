...
| {{<mib_link url="mibs/CUMULUS-COUNTERS-MIB.txt" text="CUMULUS-COUNTERS-MIB">}} | Discard counters and interface counters. `/usr/share/snmp/mibs/Cumulus-Counters-MIB.txt` defines this MIB, which has the OID `.1.3.6.1.4.1.40310.2`.|
