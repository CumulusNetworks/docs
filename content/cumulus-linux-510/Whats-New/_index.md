...
- {{<link url="Equal-Cost-Multipath-Load-Sharing/#adaptive-routing" text="Adaptive routing stateless containers">}} for resource optimization in large scale deployments
