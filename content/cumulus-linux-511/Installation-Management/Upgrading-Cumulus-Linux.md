...
- Install a new Cumulus Linux image with {{<link url="#image-upgrade" text="ONIE">}}.
...
12. Repeat steps 2-8 on the new secondary switch.
...
The SN3700C-S, SN5400, and SN5600 secure boot switch running Cumulus Linux 5.11.0 boots with shim 15.8 that adds entries to the SBAT revocations to prevent the switch from booting shim 15.7 or earlier (in Cumulus Linux 5.10 and earlier), which has security vulnerabilities.
