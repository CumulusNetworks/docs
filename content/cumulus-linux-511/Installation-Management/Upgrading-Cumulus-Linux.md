...
{{%notice note%}}
- To upgrade to Cumulus Linux 5.11 from Cumulus Linux 4.x or 3.x, you must install a disk image of the new release using ONIE. You *cannot* upgrade packages with package upgrade.
