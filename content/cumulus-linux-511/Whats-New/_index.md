...
{{%notice note%}}
- You can use package upgrade to upgrade the switch to Cumulus Linux 5.11.2 from Cumulus Linux 5.11.1 or 5.11.0. To upgrade from Cumulus Linux 5.9, you must first package upgrade to 5.11.0.
