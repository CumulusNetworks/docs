...
| `nv config show` | Shows the {{<link url="show-switch-configuration" text="currently applied configuration">}} in `yaml` format. This command also shows NVUE version information. |
