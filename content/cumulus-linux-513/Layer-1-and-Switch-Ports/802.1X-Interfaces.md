...
If a supplicant is in the Authorized state, and you want to retain its access even when reauthentication fails due to a RADIUS server timeout, run the following commands to ignore server timeout.
