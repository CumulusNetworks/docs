...
Review {{<link url="#warm-reboot-and-issu-considerations" text="Warm Reboot and ISSU Considerations">}} to understand additional support limitations and requirements for warm reboots and ISSU. 
{{%/notice%}}
<!--
{{%notice note%}}
