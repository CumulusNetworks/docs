...
{{%notice warning%}}
If you use Linux commands to configure the switch, read the following information before you upgrade to Cumulus Linux 5.13.0.
{{%/notice%}}
...
1. **Before** you upgrade to 5.13.0, disable NVUE auto save:
