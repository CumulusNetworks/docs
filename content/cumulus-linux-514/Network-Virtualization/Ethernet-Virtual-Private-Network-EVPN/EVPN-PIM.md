...
{{%notice note%}}
If you use a PIM-SM based <span class="a-tooltip">[MDT](## "Multicast Distribution Tree")</span> for EVPN BUM replication, NVIDIA recommends that you use {{<link url="EVPN-Multihoming" text="EVPN multihoming">}}.
{{%/notice%}}
