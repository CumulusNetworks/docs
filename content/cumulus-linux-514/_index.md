...
Cumulus Linux 5.14 includes the NVIDIA NetQ agent and CLI. You can use NetQ to monitor and manage your data center network infrastructure and operational health. Refer to the {{<exlink url="https://docs.nvidia.com/networking-ethernet-software/cumulus-netq" text="NVIDIA NetQ documentation" >}} for details.

For a list of the new features in this release, see {{<link url="Whats-New" text="What's New">}}. For bug fixes and known issues present in this release, refer to the {{<link url="Cumulus-Linux-5.14-Release-Notes" text="Cumulus Linux 5.14 Release Notes">}}.
<!-- vale off -->
...
- For a fully functional copy of the user guide, download a zip file of the {{<exlink url="https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-514/CL514-html.zip" text="HTML documentation">}} for offline use, extract it locally, then open `cumulus-linux-<release>.html` in your web browser.
