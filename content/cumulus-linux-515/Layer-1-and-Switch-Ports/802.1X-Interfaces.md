...
3. Generates the IPv6 address for the interface and assigns the address to the port.
...
- Configure BGP summary route redistribution; create a route map with a static protocol match and set the tag to the same value as the route tag in the IPv6 profile.
...
Configure BGP summary route redistribution:
