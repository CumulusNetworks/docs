...
The example commands change the maximum number of paths to 128. On Spectrum-1 switches, you can set a value between 1 and 64. On Spectrum-2 and later, you can set a value between 1 and 256. 1 disables the BGP multipath option.
