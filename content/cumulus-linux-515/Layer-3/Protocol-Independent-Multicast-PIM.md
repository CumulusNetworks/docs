...
These examples use the `default` VRF. If your configuration uses a different VRF for PIM, replace `vrf default` with the appropriate VRF name (for example, `vrf RED`).
...
These example use the `default` VRF. If your configuration uses a different VRF for PIM, replace `vrf default` with the appropriate VRF name (for example, `vrf RED`).
