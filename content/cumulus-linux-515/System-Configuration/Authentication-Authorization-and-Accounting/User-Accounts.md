...
nv set system aaa user $test_user
nv set system aaa user test.user

Examples of valid user names:
nv set system aaa user t3st_user
nv set system aaa user test_user$
nv set system aaa user _test_user
{{%/notice%}}
