...
The NVUE object model supports most features on the Cumulus Linux switch. The following list shows the supported objects. The NVUE API supports more objects within each of these objects. To see a full listing of the supported API endpoints, refer to the {{<exlink url="https://api-prod.nvidia.com/openapi-browser?spec=openapi+5.15.0.json" text="NVUE API browser tool">}}.
...
For more information about using the NVUE REST API, reference the {{<exlink url="https://api-prod.nvidia.com/openapi-browser?spec=openapi+5.15.0.json" text="NVUE API browser tool">}}. This tool is still under development. Please report any issues or feedback to nvue-openapi-browser-support@nvidia.com.
