...
## <h>nv set interface \<interface-id\> neighbor ipv4 \<ip-address\> lladdr \<lladdr-id\></h>
...
## <h>nv set interface \<interface-id\> neighbor ipv4 \<ip-address\> lladdr \<lladdr-id\> flag</h>
...
## <h>nv set interface \<interface-id\> neighbor ipv4 \<ip-address\> lladdr \<lladdr-id\> state</h>
