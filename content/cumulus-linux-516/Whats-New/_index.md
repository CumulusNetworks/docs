...
Cumulus Linux 5.16.3 provides a {{<link title="Cumulus Linux 5.16 Release Notes" text="bug fix">}} and a security update.

## What's New in Cumulus Linux 5.16.2

Cumulus Linux 5.16.2 provides {{<link title="Cumulus Linux 5.16 Release Notes" text="bug fixes">}}.
