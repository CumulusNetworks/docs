...
- For a fully functional copy of the user guide, download a zip file of the {{<exlink url="https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-516/CL516-html.zip" text="HTML documentation">}} for offline use, extract it locally, then open `cumulus-linux-<release>.html` in your web browser.
