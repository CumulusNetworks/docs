...
- 802.1X reauthentication on an interface. You can enable or disable reauthentication on specific interfaces.
...
--------------                        -----------   ---------- 
eap                                   enabled      	enabled 
mba                                   disabled      disabled 
auth-fail-vlan                        disabled 
host-mode                             multi-host 
ipv6-profile
port-id                               auto 
unsolicited-identity-request-frames   4
```
