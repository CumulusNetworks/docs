...
To show information about a specific micro update, such as a summary, description, impact, installation time, failure reason, and its applied status, run the `nv show system packages archive <archive-id>` command:
