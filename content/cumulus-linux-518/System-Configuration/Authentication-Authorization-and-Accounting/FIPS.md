...
- If you upgrade to Cumulus Linux 5.18 or later from Cumulus Linux 5.16 with FIPS enabled and RADIUS authentication configured with CHAP authentication (either globally, or for a server), the upgrade process changes the authentication type to PEAP-GTC.
