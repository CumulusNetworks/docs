...
- NVUE
  ...
  - {{<link url="Monitoring-Interfaces-and-Transceivers-with-NVUE/#amber-phy-health-management" text="Command to show a tabular summary of PHY health statistics for all switch port interfaces ">}}
