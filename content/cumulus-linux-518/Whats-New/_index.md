...
- NVUE
  ...
  - {{<link url="Resource-Diagnostics" text="NVUE action command to clear resource metrics for a specific ASIC">}}
  - {{<link url="Resource-Diagnostics" text="Updated nv show platform asic <asic-id> resource command output">}}
