---
title: Cumulus Linux 5.18 User Guide
author: NVIDIA
weight: -42
subsection: true
cascade:
...
For a list of the new features in this release, see {{<link url="Whats-New" text="What's New">}}. For bug fixes and known issues present in this release, refer to the {{<link url="Cumulus-Linux-5.18-Release-Notes" text="Cumulus Linux 5.18 Release Notes">}}.
...
NVIDIA has also developed and released new applications as open source. The list of open source projects is on the {{<link title="Cumulus Linux 5.18 Packages" text="Cumulus Linux packages" >}} page.
...
- For a fully functional copy of the user guide, download a zip file of the {{<exlink url="http://docs.nvidia.com/networking-ethernet-software/cumulus-linux-518/CL5-18-docs-html.zip" text="HTML documentation">}} for offline use, extract it locally, then open `cumulus-linux-<release>.html` in your web browser.
