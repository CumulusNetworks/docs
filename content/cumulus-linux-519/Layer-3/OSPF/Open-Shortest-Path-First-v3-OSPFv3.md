...
- Cumulus Linux 5.14 and later provides new vtysh commands to configure the area for OSPFv3 interfaces. If you configure OSPFv3 areas with NVUE snippets in Cumulus Linux 5.13 and earlier, you must delete the snippets before you upgrade to Linux 5.19, then reconfigure the areas for OSPFv3 interfaces with the new vtysh commands after upgrade.
{{%/notice%}}
