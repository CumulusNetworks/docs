...
====================
    ...
    ------------------  -------------------------------  ------------  -------------------  -----  -------
    repo                cumulus-linux-apt-mirror:5.19.0  a941e1e51c3e  Up 6 days (healthy)                
```
...
------------  ------------------------  ------  ------  -----------------------------  -------
d839322a5483  cumulus-linux-apt-mirror  5.19.0  3.47GB  2025-10-30 02:35:30 -0400 EDT      
```
...
image-name     cumulus-linux-apt-mirror:5.19.0
port                                          
stats                                         
  cpu          0.00%                          
  mem-usage    8.105MiB                       
