---
title: Cumulus Linux 5.19 User Guide
author: NVIDIA
weight: -42
subsection: true
cascade:
...
For a list of the new features in this release, see {{<link url="Whats-New" text="What's New">}}. For bug fixes and known issues present in this release, refer to the {{<link url="Cumulus-Linux-5.19-Release-Notes" text="Cumulus Linux 5.19 Release Notes">}}.
...
NVIDIA has also developed and released new applications as open source. The list of open source projects is on the {{<link title="Cumulus Linux 5.19 Packages" text="Cumulus Linux packages" >}} page.
