---
title: Cumulus Linux 5.2 User Guide
author: NVIDIA
weight: -42
subsection: true
cascade:
...
Cumulus Linux 5.2 includes the NVIDIA NetQ agent and CLI. You can use NetQ to monitor and manage your data center network infrastructure and operational health. Refer to the [NVIDIA NetQ documentation]({{<ref "/cumulus-netq-42" >}}) for details.
