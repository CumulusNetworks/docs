...
| {{<mib_link url="mibs/CUMULUS-BGPVRF-MIB.txt" text="CUMULUS-BGPVRF-MIB">}} | Cumulus Linux also includes its own BGP VRF attribute MIB, defined in `/usr/share/snmp/mibs/Cumulus-BGPVRF-MIB.txt`.|
