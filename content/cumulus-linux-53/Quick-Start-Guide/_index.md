...
2. {{<exlink url="https://enterprise-support.nvidia.com/s/downloader" text="Download">}} the Cumulus Linux installation file to the root directory of your web server and rename the downloaded file to `onie-installer`.
