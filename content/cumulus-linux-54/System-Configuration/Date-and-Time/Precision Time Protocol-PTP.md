...
PTP frames are affected by <span style="background-color:#F5F5DC">[STP](## "Spanning Tree Protocol")</span> filtering; events, such as a STP topology change (where ports temporarily go into the blocking state), can cause interruptions to PTP communications.
