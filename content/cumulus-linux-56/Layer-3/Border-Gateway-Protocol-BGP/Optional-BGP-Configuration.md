...
{{<link url="In-Service-System-Upgrade-ISSU-and-System-Power" text="ISSU">}} suppresses route advertisement automatically when upgrading or troubleshooting an active switch so that there is minimal disruption to the network.
<!-- vale off -->
## BGP add-path
...
You must enable BGP graceful restart to achieve a switch restart or switch software upgrade with minimal traffic loss in a BGP configuration. Refer to {{<link url="In-Service-System-Upgrade-ISSU-and-System-Power" text="ISSU">}} for more information.
