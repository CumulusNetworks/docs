...
- WJH packet drop monitoring uses a SPAN destination; If you configure {{<link url="Mellanox-WJH" text="WJH">}}, ensure that you do not exceed the total number of SPAN destinations allowed for your switch ASIC type.
