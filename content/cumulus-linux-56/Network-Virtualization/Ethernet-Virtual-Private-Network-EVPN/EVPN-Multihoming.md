...
- Multihomed networks such as STP bridge domains that are MH connected. EVPN-MH bonds are intended for multihomed end-node device (i.e. server) connectivity.
