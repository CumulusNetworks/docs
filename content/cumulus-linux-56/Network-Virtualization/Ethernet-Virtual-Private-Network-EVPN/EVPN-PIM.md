...
---
{{%notice info%}}
Cumulus Linux 5.6 only supports <span class="a-tooltip">[HER](## "Head End Replication")</span> for handling BUM traffic in an EVPN configuration. BUM handling using a PIM-SM Multicast tree is not supported.
{{%/notice%}}
