...
- NVUE enhancements include:
  ...
  - Show encrypted {{<link url="Optional-BGP-Configuration/#encrypted-bgp-peer-passwords" text="BGP peer passwords">}} and {{<link url="Open-Shortest-Path-First-v2-OSPFv2/#encrypted-bgp-peer-passwords" text="OSPF peer passwords">}}
