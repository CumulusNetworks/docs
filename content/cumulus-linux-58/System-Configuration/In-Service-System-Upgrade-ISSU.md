...
- Warm mode for 802.1X, layer 2 forwarding, and layer 3 forwarding with BGP, static routing and VXLAN routing with EVPN. Cumulus Linux does **not** support warm boot with EVPN MLAG or EVPN multihoming.
{{%/notice%}}
