...
weight: 91
aliases:
 - /display/CL37/Interface-Configuration-and-Management
...
Attributes](/cumulus-linux/Layer-1-and-Switch-Ports/Interface-Configuration-and-Management/Switch-Port-Attributes).
...
VRF](/cumulus-linux/Layer-3/Management-VRF), you can use the special
...
[tagged](/cumulus-linux/Layer-2/Ethernet-Bridging-VLANs/VLAN-Tagging)
...
## ifup and Upper (Parent) Interfaces</span>
...
### Purge Existing IP Addresses on an Interface</span>
...
## Source Interface File Snippets</span>
...
## Run ifupdown Scripts under /etc/network/ with ifupdown2</span>
...
## Add Descriptions to Interfaces</span>
...
[SNMP](/cumulus-linux/Monitoring-and-Troubleshooting/Simple-Network-Management-Protocol-\(SNMP\)-Monitoring/)
OID
