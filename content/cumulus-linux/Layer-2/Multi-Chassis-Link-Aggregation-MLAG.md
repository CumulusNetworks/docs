...
- If you configure MLAG with the NCLU commands, Cumulus Linux does not check against a possible collision with VLANs outside of the default reserved range when creating the peerlink interfaces, in case the reserved VLAN range has been modified.
