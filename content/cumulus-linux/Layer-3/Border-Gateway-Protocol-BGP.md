...
addresses. See
[RFC 5549 Support with Global IPv6 Peers](#configure-rfc-5549-support-with-global-ipv6-peers) below.
...
both link-local and global unicast address peerings (see
[RFC 5549 Support with Global IPv6 Peers](#configure-rfc-5549-support-with-global-ipv6-peers).
...
configure a neighbor and attach it to a
[peer group](#peer-groups-to-simplify-configuration) (making sure
...
This section describes how the IPv6 next hops are set in the MP\_REACH\_NLRI
([multiprotocol reachable NLRI](https://www.ietf.org/rfc/rfc2858.txt)) initiated by the system,
