...
The example NCLU commands below create a VRF called *mgmt*. The management VRF must be named `mgmt` to differentiate from a data
plane VRF.
...
### ping or traceroute on the Management VRF</span>
...
### Run Services as a Non-root User</span>
...
## SSH within a Management VRF Context</span>
