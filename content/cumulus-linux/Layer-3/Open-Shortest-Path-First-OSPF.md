...
This topic describes OSPFv2, which is a 
[link-state routing protocol](http://en.wikipedia.org/wiki/Link-state_routing_protocol) for
IPv4. For IPv6 commands, refer to 
...
If you disabled the
[integrated](/cumulus-linux/Layer-3/Configuring-FRRouting/#integrated-configurations)
