...
weight: 44321
aliases:
 - /display/CL3740/Troubleshooting-Log-Files
 - /pages/viewpage.action?pageId=83626026323
pageID: 83626026323
...
is amazing forto understanding how `/var/log` works. The green highlighted
 rows below are 
the most important logs and usually; looked at them first when
 debugging.
...
<p>Note that<strong>Note</strong>: Cumulus Linux does not write to this log file; but because it' is a standard file, Cumulus Linux creates it as a zero length file.</p></td>
<td><p> </p></td>
</tr>
<tr class="odd">
<td><p>/var/log/autoprovision</p></td>
<td><p>Logs output generated by running the <a href="/version/cumulus-linux-37740/Installation-Management/Zero-Touch-Provisioning---ZTP">zero touch provisioning</a> script.</p></td>
<td><p> </p></td>
</tr>
<tr class="even">
...
<td><p>Log file for <a href="/version/cumulus-linux-37740/System-Configuration/Network-Command-Line-Utility---NCLU">NCLU</a>.</p></td>
<td><p> </p></td>
</tr>
<tr class="even">
...
<td>
<p>This is how Cumulus Networks troubleshoots routing. For example, such as an mdMD5 or mtuMTU mismatch with OSPF.</p></td>
</tr>
<tr class="even">
<td><p>/var/log/rdnbrd.log</p></td>
<td><p>Logs for <a href="/version/cumulus-linux-37740/Layer-3/Redistribute-Neighbor">redistribute neighbor</a>.</p></td>
<td><p> </p></td>
</tr>
<tr class="odd">
<td><p>/var/log/snapper.log</p></td>
<td><p>Log file for <a href="/version/cumulus-linux-377/Installation-Management/Using-Snapshots">snapshots</a>.</p></td>
...
<td>
<p>The primary log; it's easiest to <code>grep</code> this file to see what problem occurred during a problem.</p></td>
</tr>
<tr class="evenodd">
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQyNzE5NjU1Ml19
-->