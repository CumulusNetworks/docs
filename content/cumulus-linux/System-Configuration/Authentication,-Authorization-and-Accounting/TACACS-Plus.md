...
Parameters](#src-8366279_TACACSPlus-TACACS_config_params) below for the
...
## <span id="src-8366279_TACACSPlus-fallback-auth" class="confluence-anchor-link"></span><span>Local Fallback Authentication</span>
...
when a [management
VRF](/version/cumulus-linux-40/Layer-3/Management-VRF) is configured,
...
## <span id="src-8366279_TACACSPlus-nclu" class="confluence-anchor-link"></span><span>Configure NCLU for TACACS+ Users</span>
...
## <span id="src-8366279_TACACSPlus-TACACS_config_params" class="confluence-anchor-link"></span><span>TACACS Configuration Parameters</span>
...
<tr class="even">
<td><p>source_ip=ipv4-address</p></td>
...
<tr class="odd">
<td><p>vrf=vrf-name</p></td>
<td><p>If the management network is in a VRF, set this variable to the VRF name. This is typically <code>mgmt</code>. When this variable is set, the connection to the TACACS+ accounting servers is made through the named VRF.</p></td>
</tr>
<tr class="even">
<td><p>service</p></td>
