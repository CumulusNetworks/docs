...
[physical servers](/cumulus-netq-10/Monitoring-Linux-Hosts-with-NetQ).
...
least 32G RAM. For more information, read the [Performing Network Diagnostics](/cumulus-netq-10/Performing-Network-Diagnostics/)
chapter.
...
See the section on [configuring the NetQ agent on a node](/cumulus-netq-10/Getting-Started-with-NetQ/#install-the-netq-agent)
