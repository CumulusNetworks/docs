...
NetQ 1.1 includes the following new features and enhancements:
  ...
  - Improved container visibility: [Docker Swarm
    integration](/cumulus-netq-110/Monitoring-Container-Environments-with-NetQ)
    provides service- and application-level insights in containerized
    environments.

  - [Layer 1
    support](/cumulus-netq-110/Monitoring-the-Physical-Layer):
  ...
  - [NetQ
    Notifier](/cumulus-netq-110/Proactively-Monitoring-the-Network-Fabric/):
    ...
    Splunk](/cumulus-netq-110/Proactively-Monitoring-the-Network-Fabric/)
    is now generally available.

  - [Telemetry
    server](/cumulus-netq-110/Getting-Started-with-NetQ/): The
  ...
  - [Standalone
    repository](/cumulus-netq-110/Getting-Started-with-NetQ/#src-7111298_GettingStartedwithNetQ-agent):
...
support for the following:
  ...
  - [Facebook
    Backpack](/cumulus-netq-110/Early-Access-Features/Facebook-Backpack-Integration)
    chassis
