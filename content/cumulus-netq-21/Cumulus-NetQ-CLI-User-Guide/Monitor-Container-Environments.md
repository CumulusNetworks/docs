...
[physical servers](/cumulus-netq-21/Cumulus-NetQ-CLI-User-Guide/Monitor-Linux-Hosts).
...
1.  Configure the host to point to the NetQ Platform by its IP address.
    See the [Install NetQ](/cumulus-netq-21/Cumulus-NetQ-Deployment-Guide/Install-NetQ/)
    topic for details.
...
described in the [Install NetQ](/cumulus-netq-21/Cumulus-NetQ-Deployment-Guide/Install-NetQ/)
...
You can use the ["time machine" features](/cumulus-netq-21/Cumulus-NetQ-CLI-User-Guide/Resolve-Issues/Methods-for-Diagnosing-Network-Issues)
