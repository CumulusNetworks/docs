...
You need to [install the OS-specific NetQ metapack](/cumulus-netq-21/Cumulus-NetQ-Deployment-Guide/Install-NetQ) on every host you want to monitor with NetQ.
...
- Docker containers - refer to the [Monitor Container Environments](/cumulus-netq-21/Cumulus-NetQ-CLI-User-Guide/Monitor-Container-Environments) topic
