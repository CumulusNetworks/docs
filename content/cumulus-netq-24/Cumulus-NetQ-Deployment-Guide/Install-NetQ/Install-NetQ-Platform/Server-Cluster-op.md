...
- {{<link title="Install the NetQ Appliance Cluster" text="Use the NetQ Appliance">}}
- {{<link title="Choose a Virtual Machine for an On-premises Server Cluster" text="Use Your Own Server with a VM">}}