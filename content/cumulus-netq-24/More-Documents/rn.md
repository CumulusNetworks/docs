...
| <a name="NETQ-5182"></a> [NETQ-5182](#NETQ-5182) <a name="NETQ-5182"></a> | When a switch or host reports its memory size in GB rather than MB, the NetQ Agent cannot parse the information and thus fails to register with the NetQ server. Contact customer support if you run into this issue. | 2.4.0-2.4.1 | 3.0.0-3.2.1|
