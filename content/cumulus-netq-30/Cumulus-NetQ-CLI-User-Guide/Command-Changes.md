...
| netq [&lt;hostname>] show interface-utilization [&lt;text-port>] [tx\|rx] [around &lt;text-time>] [json] | netq [&lt;hostname>] show interface-utils [&lt;text-port>] [tx\|rx] [around &lt;text-time>] [json] | Changed `interface-utils` option to `interface-utilization`. | 3.0.0 |
