...
| netq add trace &lt;mac> [vlan &lt;1-4096>] from (&lt;src-hostname> \| &lt;ip-src>) [vrf &lt;vrf>] [alert-on-failure] | Adds a trace for a MAC address from a hostname or IP address. | 3.1.0 |
| netq add trace name &lt;text-new-trace-name> &lt;mac> [vlan &lt;1-4096>] from (&lt;src-hostname> \| &lt;ip-src>) [vrf &lt;vrf>] interval &lt;text-time-min> [alert-on-failure] | Adds a trace to be run at a given interval for a MAC address from a hostname or IP address. | 3.1.0 |
| netq add trace &lt;ip> from (&lt;src-hostname> \| &lt;ip-src>) [vrf &lt;vrf>] [alert-on-failure] | Adds a trace for an IP address from a hostname or IP address. | 3.1.0 |
| netq add trace name &lt;text-new-trace-name> &lt;ip> from (&lt;src-hostname> \| &lt;ip-src>) [vrf &lt;vrf>] interval &lt;text-time-min> [alert-on-failure] | Adds a trace to be run at a given interval for an IP address from a hostname or IP address. | 3.1.0 |
| netq del trace &lt;text-trace-name> | Deletes a trace. | 3.1.0 |
| netq show trace settings [name &lt;text-trace-name>] [json] | Displays the settings for the specified trace. | 3.1.0 |
| netq show trace summary [name &lt;text-trace-name>] [around &lt;text-time-hr>] [json] | Displays summary information for the specified trace. | 3.1.0 |
| netq show trace results &lt;text-job-id> [json] | Displays the results for the specified trace. | 3.1.0 |
| netq add validation type (ntp \| interfaces \| license \| sensors \| evpn \| vxlan \| agents \| mlag \| vlan \| bgp \| mtu \| ospf) [alert-on-failure] | Adds a new validation. | 3.1.0 |
| netq add validation name &lt;text-new-validation-name> type (ntp \| interfaces \| license \| sensors \| evpn \| vxlan \| agents \| mlag \| vlan \| bgp \| mtu \| ospf) interval &lt;text-time-min> [alert-on-failure] | Adds a new validation to be run at a given interval. | 3.1.0 |
| netq del validation &lt;text-validation-name> | Removes a validation. | 3.1.0 |
| netq show validation settings [name &lt;text-validation-name>] [type ntp \| type interfaces \| type license \| type sensors \| type evpn \| type vxlan \| type agents \| type mlag \| type vlan \| type bgp \| type mtu \| type ospf] [json] | Displays the settings for the specified validation. | 3.1.0 |
| netq show validation summary [name &lt;text-validation-name>] type (ntp \| interfaces \| license \| sensors \| evpn \| vxlan \| agents \| mlag \| vlan \| bgp \| mtu \| ospf) [around &lt;text-time-hr>] [json] | Displays summary information for the specified validation. | 3.1.0 |
