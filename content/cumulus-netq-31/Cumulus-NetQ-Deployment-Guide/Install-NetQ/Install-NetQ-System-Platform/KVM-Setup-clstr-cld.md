...
3. Download the NetQ Platform image.
    ...
    {{<netq-install/kvm-platform-image deployment="cloud" version="3.1.0">}}

4. Setup and configure your VM.

    {{<netq-install/vm-setup hypervisor="kvm" deployment="cloud" version="3.1.0">}}
...
7. Run the Bootstrap CLI. Be sure to replace the *eth0* interface used in this example with the interface on the server used to listen for NetQ Agents.
    ...
    {{<netq-install/bootstrap version="3.1.0" server="single" platform="vm" deployment="cloud">}}
...
13. Run the Bootstrap CLI on the worker node.
    ...
    {{<netq-install/bootstrap version="3.1.0" server="cluster" platform="vm" deployment="cloud">}}
