...
| <a name="2553453"></a> [2553453](#2553453) <a name="2553453"></a> <br /> | The <code>netqd</code> daemon logs a traceback to _/var/log/netqd.log_ when the OPTA server is unreachable and <code>netq show</code> commands are run. | 3.1.0-3.3.1 | 4.0.0-4.12.0|
