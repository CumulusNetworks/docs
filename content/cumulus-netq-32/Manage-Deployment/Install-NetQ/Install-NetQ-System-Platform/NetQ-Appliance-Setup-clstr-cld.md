...
1. On the master NetQ Cloud Appliance, verify that the needed packages are present and of the correct release, version 3.2.0 and update 30.
...
5. On one of your worker NetQ Cloud Appliances, verify that the needed packages are present and of the correct release, version 3.2.0 and update 30.
...
7. Verify that the needed packages are present and of the correct release, version 3.2.0 and update 27 or later.
