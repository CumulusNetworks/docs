...
Tables can be manipulated using the settings above the tables, shown here and described in {{<link url="https://docs.cumulusnetworks.com/cumulus-netq-33/Get-Started/NetQ-User-Interface-Overview/Access-Data-with-Cards/#table-settings" text="Table Settings">}}.
