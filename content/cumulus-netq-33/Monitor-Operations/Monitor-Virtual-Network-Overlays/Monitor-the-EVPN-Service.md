...
Use the icons above the table to select/deselect, filter, and export items in the list. Refer to {{<link url="https://docs.cumulusnetworks.com/cumulus-netq-33/Get-Started/NetQ-User-Interface-Overview/Access-Data-with-Cards/#table-settings" text="Table Settings">}} for more detail.
