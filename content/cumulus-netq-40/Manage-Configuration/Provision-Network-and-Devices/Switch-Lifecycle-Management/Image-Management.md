...
9. Click **Uploaded** to verify the images are in the repository.
   ...
   When all of the missing images have been uploaded, the Missing list is empty.
...
After you upgrade all of your switches beyond a particular release, you may want to remove those images from the LCM repository to save space on the server.
