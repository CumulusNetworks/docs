...
toc: 3
---
This topic describes how to upgrade from your current NetQ 2.4.1-3.2.1 installation to the NetQ {{<version>}} release to take advantage of new capabilities and bug fixes (refer to the {{<link title="NVIDIA Cumulus NetQ 4.0 Release Notes" text="release notes">}}).
