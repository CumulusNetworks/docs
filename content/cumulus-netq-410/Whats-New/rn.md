...
| <a name="3851922"></a> [3851922](#3851922) <a name="3851922"></a> <br /> | After you run an LCM switch discovery in a NetQ cluster environment, NetQ CLI commands on switches might fail with the message <code>Failed to process command</code>. To work around this issue, manually configure the CLI on switches referencing the cluster VIP with the following commands:<pre>netq config add cli server <vip-ip>netq config restart cli</pre> | 4.10.0 | |
...
| <a name="3721754"></a> [3721754](#3721754) <a name="3721754"></a> <br /> | Please clear the release notes for this bug, it is fixed now. | 4.9.0-4.10.0 | |
