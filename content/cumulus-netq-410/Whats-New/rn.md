...
| <a name="3854467"></a> [3854467](#3854467) <a name="3854467"></a> <br /> | When the NetQ master node in a cluster is down, the NetQ kafka-connect pods might crash on other cluster nodes, preventing data collection. To work around this issue, bring the master node back into service. | 4.10.0-4.10.1 | |
