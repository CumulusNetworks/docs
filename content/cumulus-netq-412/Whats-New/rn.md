...
|---	        |---	        |---	    |---	                |
| <a name="4161354"></a> [4161354](#4161354) <a name="4161354"></a> <br /> | The NetQ UI might take several minutes to load and display BGP unestablished sessions. | 4.12.0 | |
...
| <a name="4158463"></a> [4158463](#4158463) <a name="4158463"></a> <br /> | When you add additional devices to you network, the topology view might take up to an hour to display interface transmit and receive data for the added switches. | 4.12.0 | |
...
| <a name="4134341"></a> [4134341](#4134341) <a name="4134341"></a> <br /> | If you continuously toggle the option to send all notifications to a default channel, NetQ might ignore the request. To work around this issue, refresh the page or create a new channel and set it as the default channel. | 4.12.0 | |
