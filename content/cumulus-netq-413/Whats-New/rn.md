...
| <a name="4100882"></a> [4100882](#4100882) <a name="4100882"></a> <br /> | When an exported file is very large, your browser might prevent you from opening the downloaded file. To work around this issue, use filters in the UI to decrease the size of the dataset that you intend to export and download. | 4.12.0-4.13.0 | |
