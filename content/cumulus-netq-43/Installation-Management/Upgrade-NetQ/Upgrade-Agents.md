...
{{<netq-install/agent-version version="4.3.0" opsys="cl">}}
...
{{<netq-install/agent-version version="4.3.0" opsys="ub">}}
...
{{<netq-install/agent-version version="4.3.0" opsys="rh">}} <!-- UPDATE ME! -->
...
- {{<link title="Upgrade NetQ CLI" text="Upgrade NetQ CLI">}}