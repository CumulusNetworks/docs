...
|---	        |---	        |---	    |---	                |
| <a name="3376552"></a> [3376552](#3376552) <a name="3376552"></a> <br /> | On switches running Cumulus Linux 5.4.0, the NetQ agent will crash when a frame is received on a bridge port sourcing from a MAC address of all zeroes (00:00:00:00:00:00). Switches experiencing this problem will appear as "rotten" in the NetQ UI. | 4.3.0-4.4.0 | |
