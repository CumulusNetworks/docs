...
```
netq lcm install netq-image job-name install55 netq-version 4.7.0 upgrade-cli True hostname r-qa-sw-eth-2055 ip 10.209.20.55 cpu_arch x86_64 cl_version 5.3.0
```
### Related Commands
