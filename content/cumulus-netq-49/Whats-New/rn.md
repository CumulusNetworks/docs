...
| <a name="3757698"></a> [3757698](#3757698) <a name="3757698"></a> <br /> | When you change the hostname of a NetQ cluster node after installation, details for the node are not visible in the NetQ UI. To work around this issue, restart the NetQ agent on cluster nodes with the <code>netq config restart agent</code> command after changing the hostname . |  | |
