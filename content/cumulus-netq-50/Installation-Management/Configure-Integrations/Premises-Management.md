...
{{<figure src="/images/netq/appmgmt-multisite-onprem-fulldeploy-330.png" alt="" height="300" width="600">}}
...
4. Enter the IP address for the external server, your username, and password. The username and password are the same credentials used to log in to the UI for the external server. Select **Next**
    ...
    {{<figure src="/images/netq/external-premises-credentials.png" alt="dialog prompting the user to enter the external server's IP and credentials" height="300" width="350">}}

5. Select the premises you want to connect, then click **Finish**.

    {{<figure src="/images/netq/additional-external-premises.png" alt="dialog displaying two premises" height="300" width="350">}}
...
{{<figure src="/images/netq/appmgmt-multisite-onprem-mixeddeploy-330.png" alt="" height="270" width="500">}}
...
{{<figure src="/images/netq/premises-view-config-key.png" alt="" height="200" width="350">}}
...
{{<figure src="/images/netq/new-premises-config-key.png" alt="dialog displaying configuration key with options to copy or share the key" height="270" width="650">}}
