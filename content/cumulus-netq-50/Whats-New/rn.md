...
| <a name="4693161"></a> [4693161](#4693161) <a name="4693161"></a> <br /> | In cluster and scale cluster deployments, the snapshot comparison feature may time out when comparing MAC addresses. | 5.0.0-5.0.1 | |
| <a name="4689932"></a> [4689932](#4689932) <a name="4689932"></a> <br /> | Node reservation for NetQ is not supported in shared multi-node clusters. To work around this issue, deploy NetQ in a dedicated single-node or three-node cluster first, and then scale the deployment by adding nodes for other applications. | 5.0.0-5.0.1 | |
...
| <a name="4667571"></a> [4667571](#4667571) <a name="4667571"></a> <br /> | NetQ might return inconsistent results when queries use the regular expression wildcard. | 5.0.0-5.0.1 | |
| <a name="4637749"></a> [4637749](#4637749) <a name="4637749"></a> <br /> | When the master node is down,  the <code>netq show status</code> command might report an incorrect status. | 5.0.0-5.0.1 | |
