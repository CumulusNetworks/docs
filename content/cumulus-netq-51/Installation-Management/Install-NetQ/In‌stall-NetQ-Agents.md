...
To install the NetQ Agent you need to install `netq-agent` on each server. This is available from the {{<exlink url="https://edge.urm.nvidia.com/artifactory/sw-nbu-netq-debian/pool/netq-5.1/" text="NetQ repository">}}.
...
2. Verify you have the correct version of the Agent.
    ...
    {{<netq-install/agent-version version="5.1.0" opsys="cl">}}
...
2. Verify that you have the correct agent version.
    ...
    {{<netq-install/agent-version version="5.1.0" opsys="ub">}}
