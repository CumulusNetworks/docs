...
4. Download the NetQ Debian packages needed for upgrade from the {{<exlink url="https://edge.urm.nvidia.com/artifactory/sw-nbu-netq-debian/pool/netq-5.1/" text="NetQ repository">}}, selecting the appropriate OS version and architecture. Place the files in an accessible part of your local network.
...
2. Download the NetQ Debian packages needed for upgrade from the {{<exlink url="https://edge.urm.nvidia.com/artifactory/sw-nbu-netq-debian/pool/netq-5.1/" text="NetQ repository">}}, selecting the appropriate version and hypervisor/platform. Place them in an accessible part of your local network.
...
```
nvidia@switch:~$ netq lcm add image /path/to/download/netq-agent_5.1.0-cld12u7_amd64.deb
nvidia@switch:~$ netq lcm add image /path/to/download/netq-apps_5.1.0-cld12u7_amd64.deb
```
