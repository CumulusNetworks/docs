...
```
nvidia@<hostname>:~$ netq install cluster combined bundle /mnt/installables/NetQ-5.2.1.tgz /tmp/cluster-install-config.json
```
...
```
nvidia@<hostname>:~$ netq install cluster combined bundle /mnt/installables/NetQ-5.2.1.tgz /tmp/cluster-install-config.json restore /home/nvidia/combined_backup_20241211111316.tar
```
