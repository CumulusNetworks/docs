...
- 5.6.0 or later: you can upgrade up to Cumulus Linux version 5.9 or later if your environment is running NetQ 4.10.1 or later. If you are running an earlier NetQ version, you must {{<link title="Upgrade NetQ Agent" text="upgrade NetQ">}} before you upgrade Cumulus Linux.
...
```
nvidia@switch:~$ netq lcm upgrade cl-image job-name upgrade-example cl-version 5.15.0 netq-version 5.2.1 hostnames spine01,spine02
```
...
```
nvidia@switch:~$ netq lcm upgrade cl-image job-name upgrade-example cl-version 5.15.0 netq-version 5.2.1 hostnames spine01,spine02,leaf01,leaf02 order spine,leaf run-snapshot-before-after
```
...
```
nvidia@switch:~$ netq lcm upgrade cl-image name upgrade-example cl-version 5.15.0 netq-version 5.2.1 hostnames spine01,spine02,leaf01,leaf02 order spine,leaf run-restore-on-failure
```
