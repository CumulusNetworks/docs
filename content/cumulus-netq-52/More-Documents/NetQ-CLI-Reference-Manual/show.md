...
netq [<hostname>] show events
    ...
    [message_type agent|bgp|btrfsinfo|cable|clsupport|configdiff|correlation|evpn|interfaces|lcm|link|lldp|mlag|mtu|node|ntp|port|ptp|resource|roceconfig|runningconfigdiff|sensor|services|ssdutil|tca_bgp|tca_dom|tca_ethtool|tca_hostd_roce|tca_link|tca_procdevstats|tca_resource|tca_roce|tca_sensors|tca_services|tca_wjh|topology|trace|vlan|vxlan]
    [between <text-time> and <text-endtime>]
    [json]
```
...
Displays the status of the various applications and services running on NetQ on-premises or cloud deployments. Note that when running this command as part of an installation, it takes at least 15 minutes for the applications and services to become fully operational.
...
------------------------------------ ------------------------- --------------------------
5.0.0                               Mon Jul 14 14:20:49 2025  Mon Jul 14 15:40:52 2025
```
