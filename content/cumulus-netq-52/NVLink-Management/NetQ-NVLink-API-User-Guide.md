...
- {{<exlink url="http://docs.nvidia.com/networking-ethernet-software/netq-nvlink-api-520/" text="REST API in Swagger">}}
- {{<exlink url="https://docs.nvidia.com/networking-ethernet-software/netq-nvlink-api-520/openapi.yaml" text="View the full object model">}}
