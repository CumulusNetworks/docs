...
```
nvidia@<hostname>:~$ netq install cluster combined bundle /mnt/installables/NetQ-5.3.0.tgz /tmp/cluster-install-config.json
```
...
```
nvidia@<hostname>:~$ netq install cluster combined bundle /mnt/installables/NetQ-5.3.0.tgz /tmp/cluster-install-config.json restore /home/nvidia/combined_backup_20241211111316.tar
```
