...
```
nvidia@<hostname>:~$ netq upgrade bundle /mnt/installables/NetQ-5.3.0.tgz
```
{{%notice info%}}
...
```
nvidia@<hostname>:~$ netq upgrade bundle /mnt/installables/NetQ-5.3.0.tgz <cluster-vip>
```
{{</tab>}}
...
```
nvidia@<hostname>:~$ netq upgrade nvl bundle /mnt/installables/NetQ-5.3.0.tgz kong-rw-password <rw-password> kong-ro-password <ro-password> /home/nvidia/nvl-cluster-config.json
```
{{</tab>}}
...
```
nvidia@<hostname>:~$ netq upgrade cluster bundle /mnt/installables/NetQ-5.3.0.tgz /tmp/combined-cluster-config.json
```
...
```
nvidia@<hostname>:~$ netq install cluster extend-cluster bundle /mnt/installables/NetQ-5.3.0.tgz /tmp/combined-cluster-config.json
```
