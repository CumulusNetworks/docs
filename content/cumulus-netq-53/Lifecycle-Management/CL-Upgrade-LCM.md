...
```
nvidia@switch:~$ netq lcm upgrade cl-image job-name upgrade-example cl-version 5.15.0 netq-version 5.3.0 hostnames spine01,spine02
```
...
```
nvidia@switch:~$ netq lcm upgrade cl-image job-name upgrade-example cl-version 5.15.0 netq-version 5.3.0 hostnames spine01,spine02,leaf01,leaf02 order spine,leaf run-snapshot-before-after
```
...
```
nvidia@switch:~$ netq lcm upgrade cl-image name upgrade-example cl-version 5.15.0 netq-version 5.3.0 hostnames spine01,spine02,leaf01,leaf02 order spine,leaf run-restore-on-failure
```
