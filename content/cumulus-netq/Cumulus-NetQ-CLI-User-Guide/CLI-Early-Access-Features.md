...
- Topology view (GUI Cloud deployments only), refer to [UI Early Access Features](/cumulus-netq/Cumulus-NetQ-UI-User-Guide/Monitor-the-Network/CLI-Early-Access-Features/)
...
```
cumulus@oob-mgmt-server:~$ netq check evpn exclude 0,6
evpn check result summary:
...
```
cumulus@oob-mgmt-server:~$ netq check evpn include 0-4
evpn check result summary:
