...
1. Prepare the nodes. Refer to the relevant server cluster instructions in [Prepare for NetQ Cloud Installation](../Install-NetQ/Install-NetQ-Hardware/Prepare-NetQ-Cloud/).
