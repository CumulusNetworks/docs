...
3. Configure the CLI server, using the IP address of your NetQ server, the keys you just generated, and the name of the premises (if you have more than one).
