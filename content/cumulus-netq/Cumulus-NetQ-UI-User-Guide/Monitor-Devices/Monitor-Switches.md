...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/dev-switch-small-card-230.png" width="200">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/dev-switch-medium-score-charts-230.png" width="420">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/dev-switch-large-attributes-tab-230.png" width="500">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/dev-switch-large-utilization-tab-230.png" width="500">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/dev-switch-large-interfaces-tab-230.png" width="500">}}
...
{{< figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/dev-switch-fullscr-ipaddr-tab-230.png" width="700" >}}
...
1.  Open the full screen Switch card and click the **MAC Addresses**
    ...
    {{< figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/dev-switch-fullscr-macaddr-tab-230.png" width="700" >}}
...
1.  Open the full screen Switch card and click the **All Interfaces**
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/dev-switch-fullscr-interfaces-tab-230.png" width="700">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-small-230.png" width="200">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-medium-230.png" width="200">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-large-summary-tab-230.png" width="500">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-large-asic-tab-230.png" width="500">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-large-platform-tab-230.png" width="500">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-large-software-tab-230.png" width="500">}}
...
2.  Hover over a segment of the chart to view the name, version, model
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-large-summary-tab-hover-os-230.png" width="500">}}
...
{{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-medium-hover-license-230.png" width="200">}}
...
2.  Hover over the *largest* segment in the ASIC chart. The tooltip that
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-medium-asic-highlight-230.png" width="200">}}
...
5.  *Hover* over the **Vendor** pie chart
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-large-asic-tab-vendor-highlight-230.png" width="500">}}
...
6.  *Click* on a segment of the
    **Vendor** pie chart to drill down and see only that Vendor and its
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-large-asic-tab-vendor-selected-230.png" width="500">}}
...
2.  View the number in the **Unique** column next to Agent.
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-medium-agent-highlight-230.png" width="200">}}
...
8.  Hover over the Operating System chart to see which NetQ Agent
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/inventory-switch-large-software-tab-os-highlight-230.png" width="500">}}
