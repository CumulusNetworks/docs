...
<tr class="odd">
<td><p>Alarms</p></td>
<td><p>When selected, displays distribution and count of alarms by alarm category, generated by this switch during the designated time period</p></td>
</tr>
<tr class="even">
<td><p>Charts</p></td>
<td><p>When selected, displays distribution of alarms by alarm category, during the designated time period</p></td>
</tr>
</tbody>
</table>
...
as line charts over time, by clicking **Charts** or **Alarms** at the top
of the card.
...
1.  Open the full screen Switch card and click the **MAC Addresses**
    ...
    {{< figure src="/images/netq/dev-switch-fullscr-macaddr-tab-231.png" width="700" >}}
