...
{{<figure src="/images/netq/inventory-switch-medium-hover-license-230.png" width="500">}}
...
2.  Hover over the *largest* segment in the ASIC chart. The tooltip that
    ...
    {{<figure src="/images/netq/inventory-switch-medium-asic-highlight-230.png" width="500">}}
