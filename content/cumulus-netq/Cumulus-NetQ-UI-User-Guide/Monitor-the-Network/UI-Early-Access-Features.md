...
- Detailed `netq check` validation output (CLI only), refer to [CLI Early Access Features](/cumulus-netq/Cumulus-NetQ-CLI-User-Guide/CLI-Early-Access-Features/)
...
To open the topology view, simply click x in any workbench header.
...
| Symbol | Usage |
| :----: | ----- |
| Gray or white circle | Monitored network node (switches and hosts) |
| <img src="https://icons.cumulusnetworks.com/03-Computers-Devices-Electronics/09-Hard-Drives/hard-drive-1.svg", height="18", width="18"/> | Switch |
| <img src="https://icons.cumulusnetworks.com/12-Design/08-Grids-Rulers/grid-monitor.svg", height="18", width="18"/> | Host |
| <img src="https://icons.cumulusnetworks.com/01-Interface-Essential/20-Alert/alarm-bell.svg", height="18", width="18"/> | Alarm event is present |
| <img src="https://icons.cumulusnetworks.com/22-Social-Medias-Rewards-Rating/13-Flags/flag-plain-1.svg", height="18", width="18"/> | Info event is present |
...
{{<figure src="/images/netq/topo-hover-link-230.png" width="700">}}
...
{{<figure src="/images/netq/topo-link-detail-230.png" width="700">}}
...
| <img src="https://icons.cumulusnetworks.com/01-Interface-Essential/20-Alert/alarm-bell.svg", height="18", width="18"/> | Number of alarm events present on the switch |
| <img src="https://icons.cumulusnetworks.com/01-Interface-Essential/20-Alert/alarm-bell.svg", height="18", width="18"/> | Number of info events present on the switch |
...
{{%notice tip%}}
You cannot open the Configuration Panel by clicking on the <img src="https://icons.cumulusnetworks.com/52-Arrows-Diagrams/01-Arrows/arrow-button-right-2.svg", height="18", width="18"/> as the application does not know what data you want to see. You must click on a node or link to open the panel.
{{%/notice%}}

You can change the time period for the data as well. This enables you to view the state of the network in the past and compare it with the current state. Use the time picker in the topology header to select an alternate time period.
...
{{<figure src="/images/netq/topo-export-button-230.png" width="150">}}
