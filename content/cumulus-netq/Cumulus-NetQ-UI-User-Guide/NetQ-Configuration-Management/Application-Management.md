...
[Set User Preferences](/cumulus-netq/Cumulus-NetQ-UI-User-Guide/NetQ-User-Interface-Overview/Set-User-Preferences).
...
{{%notice note%}}
For on-premises deployments, an additional LDAP Server Info card is available.
{{%/notice%}}
