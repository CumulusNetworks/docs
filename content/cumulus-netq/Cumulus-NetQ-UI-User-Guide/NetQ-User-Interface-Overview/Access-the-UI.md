...
2.  Enter the following URL into the Address bar for the on-site NetQ Platform/NetQ Appliance or the NetQ Cloud Appliance:  
    ...
    {{< figure src="https://dkahegywkrw3e.cloudfront.net/images/netq/access-ui-login-screen-230.png" width="700" >}}

3.  Select your language of choice (English or Spanish) from the dropdown at the top of the window.

    {{< figure src="https://dkahegywkrw3e.cloudfront.net/images/netq/access-ui-login-language-selection-230.png" width="150" >}}
...
4.  Enter your username and then your password:  
    ...
    {{< figure src="https://dkahegywkrw3e.cloudfront.net/images/netq/access-ui-cumulus-wb-230.png" width="700" >}}
...
2.  Select **Log Out**.  
    ...
    {{< figure src="https://dkahegywkrw3e.cloudfront.net/images/netq/access-ui-logout-230.png" width="150" >}}
