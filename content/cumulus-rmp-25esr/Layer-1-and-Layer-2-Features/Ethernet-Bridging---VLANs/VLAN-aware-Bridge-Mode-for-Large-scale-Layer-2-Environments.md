...
[ifupdown2](/cumulus-rmp-25esr/Configuring-and-Managing-Network-Interfaces/).
...
Note the attributes used in the stanza:
  ...
  - [STP](/cumulus-rmp-25esr/Layer-1-and-Layer-2-Features/Spanning-Tree-and-Rapid-Spanning-Tree)
...
## Caveats and Errata</span>
  ...
  - **VLAN translation:** A bridge in VLAN-aware mode cannot have VLAN
    ...
    mode](/cumulus-rmp-25esr/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/)
