...
## <span id="src-5118727_VLAN-awareBridgeModeforLarge-scaleLayer2Environments-svi" class="confluence-anchor-link"></span>VLAN Layer 3 Addressing/Switch Virtual Interfaces and other VLAN Attributes </span>
...
## <span id="src-5118727_VLAN-awareBridgeModeforLarge-scaleLayer2Environments-glob" class="confluence-anchor-link"></span>Using the glob Keyword to Configure Multiple Ports in a Range</span>
...
## Caveats and Errata</span>
  ...
  - **VLAN translation:** A bridge in VLAN-aware mode cannot have VLAN
    ...
    mode](/cumulus-rmp-30/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/)
