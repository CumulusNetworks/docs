...
For more information on network interfaces, see [Layer 1 and Switch Port Attributes](/cumulus-rmp-31/Configuring-and-Managing-Network-Interfaces/).
...
link speed, and so
forth](/cumulus-rmp-31/Configuring-and-Managing-Network-Interfaces/Layer-1-and-Switch-Port-Attributes).
