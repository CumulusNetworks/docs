...
For more information on network interfaces, see [Layer 1 and Switch Port Attributes](/cumulus-rmp-321/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes).
...
## <span id="src-5127616_InterfaceConfigurationandManagement-classes" class="confluence-anchor-link"></span>ifupdown2 Interface Classes</span>
...
link speed, and so
forth](/cumulus-rmp-321/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes).
...
Interface descriptions also appear in the [SNMP OID](/cumulus-rmp-321/Monitoring-and-Troubleshooting/Monitoring-System-Hardware/#span-idsrc-5127559-monitoringsystemhardware-snmp-classconfluence-anchor-linkspanmonitoring-switch-hardware-using-snmpspan/cumulus-rmp-321/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments/)
...
## <span id="src-5127616_InterfaceConfigurationandManagement-caveats" class="confluence-anchor-link"></span>Caveats and Errata</span>
