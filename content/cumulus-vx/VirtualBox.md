...
3. Configure the **Adapters** on each VM as shown below, then click **OK** to save the network connections.
   ...
   Due to how VirtualBox manages link-local multicast frames, you must enable Promiscuous Mode on all adapters (except Adapter 1) to allow for LACP bonding to properly operate.
