...
Shows the Access Control Lists (ACLs) on the switch. You use ACLs to match packets and take actions.
...
Shows information about the Access Control Lists (ACLs) on the switch. You use ACLs to match packets and take actions.
