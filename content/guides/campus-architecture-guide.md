...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-3-tier.jpg" caption="Three-tiered hierarchical model">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-accessplus1.jpg" caption="Wireless clients and workstations behind IP phones are not directly connected to access switch ports">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-core.jpg" caption="A campus core network interconnecting several other campus segments, including a large server room">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-aggregationandaccess.jpg" caption="An access and aggregation block">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-CLOSwithborder.jpg" caption="Clos or leaf/spine-style network segments. Large server rooms with two or more full racks should deploy a leaf/spine network design.">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-collapseddistronocore.jpg" caption="A cluster of buildings with interconnected distribution switches and no dedicated core layer">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-collapseddistro-access example.jpg" caption="A large campus network with collapsed distribution and access segments that route directly into the layer 3 core">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-SmallOfficeRemoteOffice.jpg" caption="Small campus networks with consolidated network layers. **Left**: A small campus site with a single LAN switch. **Right**: One collapsed layer with one MLAG switch pair and security services in the WAN edge.">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-SingleSite_LargeBuilding-Layer3withborderswitches.jpg" caption="Layer 3 ECMP design with optional border switches.">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-SingleSite_LargeBuilding-Layer3withVXLAN-MLAGnorthbound.jpg" caption="A similar design as the previous figure with distribution layer switches configured with MLAG.">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-SingleSite_LargeBuilding-Layer3withborderswitchesandVXLAN.jpg" caption="Layer 3 design using EVPN VXLAN. Access switches act as VTEPs and support VXLAN encapsulation. VLANs can be extended across the campus to other access switches across the routed distribution layer.">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-multipledistributionlayersnocore.jpg" caption="Multiple campus segments connected with a collapsed core design. Full link redundancy creates a mesh and does not scale.">}}

{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-multipledistributionlayerswithcore.jpg" caption="Multiple campus segments interconnected with a dedicated core. A network segment only needs to connect to the core instead of every other segment.">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-multipledistributionlayerswithcore-VXLANataccesslayerwithVRF.jpg" caption="Intra-VRF and inter-VRF routing paths. Not all VXLAN tunnel connections are indicated.">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-gui.png" caption="Cumulus NetQ GUI">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-json.png" caption="Cumulus NetQ CLI JSON output">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-trace.png" caption="Cumulus NetQ CLI providing layer 2, layer 3 and VXLAN overlay trace capabilities">}}
...
{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-bgp-validation.png" caption="On-demand validation of a BGP fabric from the NetQ GUI">}}

### NetQ CLI Examples

#### netq show macs

{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-show-macs.png" caption="netq show macs">}}

#### netq show ip routes

{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-show-macs.png" caption="netq show ip routes">}}

#### netq show ip address

{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-show-ip-address.png" caption="netq show ip address">}}

#### netq check

The ability to check `bgp`, `evpn`, `clag`, `interfaces`, `license`, `mtu`, `ntp`, `ospf`/`ospf6`, `sensors`, `vlan` and `vxlan` are supported.

{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-check-mtu.png" caption="netq check">}}

#### netq trace

`netq trace` provides layer 2, layer 3 and VXLAN overlay support.

{{<figure src="https://dkahegywkrw3e.cloudfront.net/images/guides/campus-netq-trace2.png" caption="Cumulus NetQ CLI providing layer 2, layer 3 and VXLAN overlay trace capabilities">}}
