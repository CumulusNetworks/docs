...
Network simulation is essential to avoid manual CLI, and copy and paste configuration errors. [NVIDIA Air](https://docs.nvidia.com/dsx-air) provides an online cloud-based network simulation platform where you can create a digital twin of your physical environment. You can build, simulate, and experience Cumulus Linux switches in AIR while testing your deployment configuration before applying it to production. Check out the [NVIDIA Air user guide](https://docs.nvidia.com/dsx-air) for more details.
