...
draft: true
---
To take a *quick* look at a Cumulus Networks golden standard demo, use our simulation platform, [Cumulus In the Cloud](https://cumulsunetworks.com/citc). The simulation platform has no system requirements or dependencies. Visit https://cumulsunetworks.com/citc to get a full blank slate Cumulus Linux reference topology; you can even one-click deploy any of the golden standard demos right from the UI.
...
3. Change to the directory created from the previous step. The directory name matches the name of the project from the git clone operation.
...
Refer to the `README.md` on the choosen Cumulus Linux Reference Topology Gitlab project and the developers guide for more information about how to start developing and building onto this blank slate topology.
