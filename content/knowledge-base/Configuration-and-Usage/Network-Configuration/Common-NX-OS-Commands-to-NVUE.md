...
For more information, refer to the {{<kb_link latest="cl" url="System-Configuration/Netfilter-ACLs" text="Netfilter - ACLs" >}} section of the Cumulus Linux User Guide.
