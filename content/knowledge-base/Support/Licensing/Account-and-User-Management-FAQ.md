...
<!-- vale on -->
Cumulus Linux 4.3 and earlier uses a generic license, which you can download from the {{<exlink url="https://enterprise-support.nvidia.com/s/" text="NVIDIA Enterprise support portal">}}. For download instructions, refer to {{<link url="Understanding-the-Cumulus-Linux-License" text="Understanding the Cumulus Linux License">}}.
