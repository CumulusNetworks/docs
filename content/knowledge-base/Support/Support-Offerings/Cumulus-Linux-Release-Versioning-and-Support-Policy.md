...
The release due in February 2024 will be an ESR candidate release for the 5.x train.

### Cumulus Linux 4.x

| Cumulus Linux Version | ESR Start Date    | End of Life Date  |
| --------------------- | ----------------- | ----------------- |
| 4.x.z (Spectrum based switches) | N/A     | December 2022     |
...
3.7.z is an ESR release for versions 3.7.12 and later. Support for 3.7 ESR will continue until February 2023. All earlier versions of 3.7.z are considered end of life and are no longer supported.
