...
- To learn about custom topologies and creating simulations with Air's drag-and-drop editor, see [Custom Topology](https://docs.nvidia.com/networking-ethernet-software/nvidia-air/Custom-Topology/).
...
After you create a simulation, you can power it on or off<!--why?-->, edit it, share it with others, or delete it by selecting the simulation's **Actions** {{<img src="/images/guides/nvidia-air/ActionsButton.png" alt="">}} menu.
...
From a simulation, click **Workspace > Edit Simulation** to edit various aspects of your simulation.
