...
The ticking timer displays when your simulation will automatically sleep, or enter a stored status to conserve system resources. You can add more time by selecting the timer's three-dot menu, then clicking **Add Time**. You can also reposition the timer by dragging it to a different part of the screen.
...
If you need to expand an organization's resources beyond the default resource budget, contact the Air Support team from the "Report An Issue" option at air.nvidia.com. <!--this will not work for external users-->
