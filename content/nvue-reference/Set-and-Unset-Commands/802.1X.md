...
## <h>nv set interface \<interface-id\> dot1x tx-identity-request max-retries</h>
...
## <h>nv set system dot1x pre-auth allow-protocol lldp</h>
...
## <h>nv set system dot1x tx-identity-request max-retries</h>
