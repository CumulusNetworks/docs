...
For an in depth discussion of ACLs, read the {{<exlink url="https://docs.cumulusnetworks.com/cumulus-linux/System-Configuration/Netfilter-ACLs/" text="Cumulus Linux">}} user guide.
