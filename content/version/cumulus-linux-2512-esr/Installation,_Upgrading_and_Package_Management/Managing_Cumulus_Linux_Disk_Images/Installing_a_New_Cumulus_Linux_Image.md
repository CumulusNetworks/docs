...
states:
  ...
  - The switch already has Cumulus Linux installed on it, so you only
    need to [upgrade
    it](/version/cumulus-linux-2512-esr/Installation_Upgrading_and_Package_Management/Managing_Cumulus_Linux_Disk_Images/Upgrading_Cumulus_Linux)
...
## <span id="src-5115997_InstallingaNewCumulusLinuxImage-dhcp_options" class="confluence-anchor-link"></span><span>Installing via a DHCP/Web Server Method with DHCP Options</span>
...
## <span id="src-5115997_InstallingaNewCumulusLinuxImage-dhcp_noopts" class="confluence-anchor-link"></span><span> Installing via a DHCP/Web Server Method without DHCP Options</span>
...
## <span id="src-5115997_InstallingaNewCumulusLinuxImage-web_nodhcp" class="confluence-anchor-link"></span><span>Installing via a Web Server with no DHCP</span>
...
## <span id="src-5115997_InstallingaNewCumulusLinuxImage-ftp" class="confluence-anchor-link"></span><span> Installing via FTP or TFTP without a Web Server</span>
...
## <span id="src-5115997_InstallingaNewCumulusLinuxImage-local" class="confluence-anchor-link"></span><span> Installing via a Local File</span>
...
## <span id="src-5115997_InstallingaNewCumulusLinuxImage-usb" class="confluence-anchor-link"></span><span>Installing via USB</span>
...
Make sure to [back
up](/version/cumulus-linux-2512-esr/Installation_Upgrading_and_Package_Management/Managing_Cumulus_Linux_Disk_Images/Upgrading_Cumulus_Linux)
...
### <span>Instructions for PowerPC and ARM Platforms</span>
...
## <span id="src-5115997_InstallingaNewCumulusLinuxImage-alreadyinstalled" class="confluence-anchor-link"></span><span>Installing a New Image when Cumulus Linux Is already Installed</span>
...
Linux](Upgrading_Cumulus_Linux.html#src-5116002_UpgradingCumulusLinux-binary_upgrade).

### <span id="src-5115997_InstallingaNewCumulusLinuxImage-oniemode" class="confluence-anchor-link"></span><span>Entering ONIE Mode from Cumulus Linux</span>
