...
### <span>Caveats and Errata</span>
  ...
  - As mentioned in [Network
    Virtualization](/version/cumulus-linux-2512-esr/Layer_1_and_Layer_2_Features/Network_Virtualization/),
...
## <span>Persistent VXLAN Configuration in NSX</span>

If you want your VXLAN configuration to persist across upgrades of
Cumulus Linux (see [Making Configurations Persist across
Upgrades](Managing_Cumulus_Linux_Disk_Images.html#src-5115988_ManagingCumulusLinuxDiskImages-persistent_config)),
