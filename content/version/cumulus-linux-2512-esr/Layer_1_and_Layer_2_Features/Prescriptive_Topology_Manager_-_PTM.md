...
## <span>Supported Features</span>
  ...
  - Forwarding path failure detection using [Bidirectional Forwarding
    ...
    below](#src-5116005_PrescriptiveTopologyManager-PTM-bfd) and see
    `man ptmd(8)`.
  ...
  - User configuration via a `topology.dot` file; [see
    below](#src-5116005_PrescriptiveTopologyManager-PTM-configuring).
...
below](#src-5116005_PrescriptiveTopologyManager-PTM-ptmd_commands).
...
chapter](/version/cumulus-linux-2512-esr/Layer_3_Features/Bidirectional_Forwarding_Detection_-_BFD).
...
that file. Use
[Quagga](/version/cumulus-linux-2512-esr/Layer_3_Features/Configuring_Quagga)
...
[Quagga](/version/cumulus-linux-2512-esr/Layer_3_Features/Bidirectional_Forwarding_Detection_-_BFD).
