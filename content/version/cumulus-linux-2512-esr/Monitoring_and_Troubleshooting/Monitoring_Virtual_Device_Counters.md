...
platforms only; see the [Cumulus Networks
HCL](http://cumulusnetworks.com/hcl/) for a list of supported Trident II
platforms.
...
driver](/version/cumulus-linux-2512-esr/Layer_1_and_Layer_2_Features/Ethernet_Bridging_-_VLANs/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments),
...
parameter](/version/cumulus-linux-2512-esr/System_Management/Configuring_switchd).
