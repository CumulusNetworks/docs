...
Image](/cumulus-linux-25esr/Installation-Upgrading-and-Package-Management/Managing-Cumulus-Linux-Disk-Images/Installing-a-New-Cumulus-Linux-Image).
...
Linux](/cumulus-linux-25esr/Installation-Upgrading-and-Package-Management/Managing-Cumulus-Linux-Disk-Images/Upgrading-Cumulus-Linux).
...
entities are created on the disk:
  ...
  - A disk partition using an ext4 file system that contains three
    ...
    *sysroot2*, and the `/mnt/persist` logical volume. The logical
    ...
    [persistent configuration](/cumulus-linux-25esr/Installation-Upgrading-and-Package-Management/Managing-Cumulus-Linux-Disk-Images/#powerpc-image-slot-overlay-detailed-information).
