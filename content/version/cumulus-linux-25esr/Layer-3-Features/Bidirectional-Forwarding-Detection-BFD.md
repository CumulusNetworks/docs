...
the [PTM `topology.dot` file](/cumulus-linux-25esr/Layer-1-and-Layer-2-Features/Prescriptive-Topology-Manager-PTM),
or using
[Quagga](/cumulus-linux-25esr/Layer-3-Features/Quagga-Overview).

The [Quagga CLI](/cumulus-linux-25esr/Layer-3-Features/Configuring-Quagga/#using-the-vtysh-modal-cli) 
...
de-registered with
[PTM](/cumulus-linux-25esr/Layer-1-and-Layer-2-Features/Prescriptive-Topology-Manager-PTM)
...
[Prescriptive Topology Manager - PTM](/cumulus-linux-25esr/Layer-1-and-Layer-2-Features/Prescriptive-Topology-Manager-PTM).
