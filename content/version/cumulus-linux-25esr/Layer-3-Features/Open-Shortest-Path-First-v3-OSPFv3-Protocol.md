...
Protocol](/cumulus-linux-25esr/Layer-3-Features/Open-Shortest-Path-First-OSPF-Protocol)
...
See [Debugging OSPF](/cumulus-linux-25esr/Layer-3-Features/Open-Shortest-Path-First-OSPF-Protocol/#debugging-ospf)
...
## Useful Links
  ...
  - [Bidirectional forwarding detection](/cumulus-linux-25esr/Layer-3-Features/Bidirectional-Forwarding-Detection-BFD)
    (BFD) and OSPF
