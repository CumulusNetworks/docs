...
platforms only; see the 
[Cumulus Networks HCL](http://cumulusnetworks.com/hcl/) 
for a list of supported Trident II platforms.
...
[VLAN-aware driver](/version/cumulus-linux-25esr/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments),
...
[`switchd` parameter](/version/cumulus-linux-25esr/System-Management/Configuring-switchd).
