...
multiple routes are installed by default. See the [ECMP section](/cumulus-linux-30/Layer-3-Features/Border-Gateway-Protocol-BGP/#span-id-src-5118393-bordergatewayprotocol-bgp-ecmp-class-confluence-anchor-link-span-ecmp-with-bgp-span)
...
3.  [Restart](/cumulus-linux-30/System-Management/Configuring-switchd/#restarting-switchd-span)
    the `switchd` service:
