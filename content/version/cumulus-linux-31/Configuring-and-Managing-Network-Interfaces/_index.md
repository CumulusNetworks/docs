...
[Management
VRF](/cumulus-linux-31/Layer-3-Features/Management-VRF), you can
...
link speed, and so
forth](/cumulus-linux-31/Configuring-and-Managing-Network-Interfaces/Layer-1-and-Switch-Port-Attributes).
...
Interface descriptions also appear in the [SNMP OID](/cumulus-linux-31/Monitoring-and-Troubleshooting/Monitoring-System-Hardware/#span-id-src-5121949-monitoringsystemhardware-snmp-class-confluence-anchor-link-span-monitoring-switch-hardware-using-snmp-span)
