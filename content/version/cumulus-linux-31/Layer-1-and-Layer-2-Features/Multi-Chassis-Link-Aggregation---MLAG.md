...
[bond](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Bonding-Link-Aggregation),
...
[BGP unnumbered](/cumulus-linux-31/Layer-3-Features/Border-Gateway-Protocol-BGP/#span-id-src-5122130-bordergatewayprotocol-bgp-unnumbered-class-confluence-anchor-link-span-using-bgp-unnumbered-interfaces-span)
interfaces.
...
[VLAN-aware bridge driver mode](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments/).
...
the [range of VLAN IDs you can use](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments/).
...
It's possible to configure MLAG with a bridge in [traditional mode](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/)
instead of [VLAN-aware mode](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments).
In order to do so, the peer link and all dual-connected links must be
configured as
[untagged/native](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/VLAN-Tagging/)
...
or [management
VRF](/cumulus-linux-31/Layer-3-Features/Management-VRF). Include
...
protocol such as
[VRR](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Virtual-Router-Redundancy-VRR)
...
Note that the
[MTU](/cumulus-linux-31/Configuring-and-Managing-Network-Interfaces/Layer-1-and-Switch-Port-Attributes/#span-id-src-5122107-layer1andswitchportattributes-mtu-class-confluence-anchor-link-span-mtu-span)
...
On the the leaf switches, [configure `mtu 9216`](/cumulus-linux-31/Configuring-and-Managing-Network-Interfaces/Layer-1-and-Switch-Port-Attributes/#span-id-src-5122107-layer1andswitchportattributes-mtu-class-confluence-anchor-link-span-mtu-span)
...
see [BPDU Guard and Bridge Assurance](/cumulus-linux-31/Layer-1-and-Layer-2-Features/Spanning-Tree-and-Rapid-Spanning-Tree/#span-id-src-5122089-spanningtreeandrapidspanningtree-bpdu-class-confluence-anchor-link-span-bpdu-guard-span).)
