...
## <span id="src-5122003_PrescriptiveTopologyManager-PTM-configuring" class="confluence-anchor-link"></span>Configuring PTM</span>
...
## <span id="src-5122003_PrescriptiveTopologyManager-PTM-example" class="confluence-anchor-link"></span>Basic Topology Example</span>
...
## <span id="src-5122003_PrescriptiveTopologyManager-PTM-advanced" class="confluence-anchor-link"></span>Advanced PTM Configuration</span>
...
### <span id="src-5122003_PrescriptiveTopologyManager-PTM-bfd" class="confluence-anchor-link"></span>Bidirectional Forwarding Detection (BFD)</span>
...
chapter](/version/cumulus-linux-31/Layer-3-Features/Bidirectional-Forwarding-Detection-BFD).
...
[Quagga](/version/cumulus-linux-31/Layer-3-Features/Bidirectional-Forwarding-Detection-BFD).
...
## <span id="src-5122003_PrescriptiveTopologyManager-PTM-quagga" class="confluence-anchor-link"></span>Enabling Quagga to Check Link State</span>
...
## <span id="src-5122003_PrescriptiveTopologyManager-PTM-ptmd_commands" class="confluence-anchor-link"></span>Using ptmd Service Commands</span>
