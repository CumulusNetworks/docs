...
multiple routes are installed by default. See the [ECMP section](/cumulus-linux-31/Layer-3-Features/Border-Gateway-Protocol-BGP/#span-id-src-5122130-bordergatewayprotocol-bgp-ecmp-class-confluence-anchor-link-span-ecmp-with-bgp-span)
...
3.  [Restart](/cumulus-linux-31/System-Management/Configuring-switchd/#span-id-src-5121932-configuringswitchd-restartswitchd-class-confluence-anchor-link-span-restarting-switchd-span#src-5121932_Configuringswitchd-restartswitchd)
    the `switchd` service:
