...
| /etc/hostname             | Configuration file for the hostname of the switch                                                    | [Quick Start Guide\#ConfiguringtheHostnameandTimeZone](/version/cumulus-linux-321/Quick-Start-Guide/#configuring-the-hostname-and-timezone)                                                | [wiki.debian.org/HowTo/ChangeHostname](https://wiki.debian.org/HowTo/ChangeHostname)                                         |
...
For more information about setting the priority, see [Understanding Switch Roles](/version/cumulus-linux-321/Layer-One-and-Two/Multi-Chassis-Link-Aggregation-MLAG/#span-idsrc-5126854-multi-chassislinkaggregation-mlag-roles-classconfluence-anchor-linkspanunderstanding-switch-roles-and-setting-priorityspan).
