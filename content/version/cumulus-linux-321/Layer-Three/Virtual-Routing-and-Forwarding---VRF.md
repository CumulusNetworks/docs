...
interfaces. Keep in mind the following for a VRF table:
  ...
  - Names for VRF tables can be up to 15 characters. However, you
    **cannot** use the name *mgmt*, as this name can **only** be used
    for [management
    VRF](/version/cumulus-linux-321/Layer-Three/Management-VRF).
...
### <span id="src-5127065_VirtualRoutingandForwarding-VRF-vrf_cmd" class="confluence-anchor-link"></span>Using the vrf Command</span>
...
#### <span id="src-5127065_VirtualRoutingandForwarding-VRF-exec" class="confluence-anchor-link"></span>Running IPv4 and IPv6 Commands in a VRF Context </span>
...
[Quagga](/version/cumulus-linux-321/Layer-Three/Quagga-Overview) learns
...
configurations](/version/cumulus-linux-321/Layer-Three/Border-Gateway-Protocol-BGP)
...
## Caveats and Errata</span>
  ...
  - You cannot configure [EVPN address
    families](/version/cumulus-linux-321/Network-Virtualization/Ethernet-Virtual-Private-Network-EVPN)
    within a VRF.
