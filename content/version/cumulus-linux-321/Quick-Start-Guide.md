...
<span class="admonition-icon confluence-information-macro-icon">
...
comparison. You can also [watch a series of short videos](http://cumulusnetworks.com/technical-videos/) introducing you to
...
you need to upgrade the software only, you can skip to [Upgrading Cumulus Linux](/cumulus-linux-321/Installation-Management/Managing-Cumulus-Linux-Disk-Images/Upgrading-Cumulus-Linux/)
below.
...
[Installing a New Cumulus Linux Image](/cumulus-linux-321/Installation-Management/Managing-Cumulus-Linux-Disk-Images/Installing-a-New-Cumulus-Linux-Image)
...
discovery methods, refer to the [ONIE documentation](https://github.com/opencomputeproject/onie/wiki/Design-Spec-SW-Image-Discovery).
...
### <span id="src-5126745_QuickStartGuide-upgrading-cumulus-linux" class="confluence-anchor-link">Upgrade to the Latest Version
...
Cumulus Linux 3.0.0 or later installed on your switch, read [Upgrading Cumulus Linux](/cumulus-linux-321/Installation-Management/Managing-Cumulus-Linux-Disk-Images/Upgrading-Cumulus-Linux/)
...
For more information about sudo, read [Using sudo to Delegate Privileges](/cumulus-linux-321/System-Configuration/Authentication-Authorization-and-Accounting/Using-sudo-to-Delegate-Privileges).

### Serial Console Management

Users are encouraged to perform management and configuration over the
network, [either in band or out of band](/cumulus-linux-321/Installation-Management/Managing-Cumulus-Linux-Disk-Images/Upgrading-Cumulus-Linux/).
...
and time are correct. You must [correct the time](/cumulus-linux-321/System-Configuration/Setting-Date-and-Time)
...
[Layer 1 and Switch Port Attributes](/cumulus-linux-321/Interface-Configuration-and-Management/Layer-1-and-Switch-Port-Attributes/#span-idsrc-5126996-layer1andswitchportattributes-breakout-classconfluence-anchor-linkspanconfiguring-breakout-portsspan).
...
A script is available to generate a configuration that [places all physical ports in a single bridge](https://support.cumulusnetworks.com/hc/en-us/articles/203508477).
