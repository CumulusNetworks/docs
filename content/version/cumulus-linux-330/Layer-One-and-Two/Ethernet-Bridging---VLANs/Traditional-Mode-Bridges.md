...
2.  Add a new stanza to create the bridge, and save the file. The
    ...
    <p>For more information on spanning-tree configurations see the configuration section: <a href="/version/cumulus-linux-330/Layer-One-and-Two/Spanning-Tree-and-Rapid-Spanning-Tree">Spanning Tree and Rapid Spanning Tree</a>.</p></td>
    <td><p>off</p></td>
    </tr>
    </tbody>
    </table>
...
## <span id="src-5866205_TraditionalModeBridges-VLAN_tagging" class="confluence-anchor-link"></span>Using Trunks in Traditional Bridge Mode</span>
...
chapter](/version/cumulus-linux-330/Layer-One-and-Two/Ethernet-Bridging-VLANs/VLAN-Tagging).
