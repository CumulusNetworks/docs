...
You can use
[`cl-resource-query`](/version/cumulus-linux-330/Monitoring-and-Troubleshooting/Resource-Diagnostics-Using-cl-resource-query)
to determine the current table sizes on a given switch.

### <span id="src-5866425_Routing-uft" class="confluence-anchor-link"></span>Forwarding Table Profiles</span>
...
### <span id="src-5866425_Routing-tcam" class="confluence-anchor-link"></span>TCAM Resource Profiles for Mellanox Switches</span>
...
When [nonatomic
updates](Netfilter-ACLs.html#src-5866114_Netfilter-ACLs-nonatomic) are
