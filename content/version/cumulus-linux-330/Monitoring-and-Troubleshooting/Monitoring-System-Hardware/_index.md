...
You monitor system hardware in these ways, using:
  ...
  - [Net-SNMP](/version/cumulus-linux-330/Monitoring-and-Troubleshooting/SNMP-Monitoring/)
...
## <span id="src-5866131_MonitoringSystemHardware-snmp" class="confluence-anchor-link"></span>Monitoring Switch Hardware Using SNMP</span>

The Net-SNMP documentation is discussed
[here](/version/cumulus-linux-330/Monitoring-and-Troubleshooting/SNMP-Monitoring/).
...
## <span id="src-5866131_MonitoringSystemHardware-watchdog" class="confluence-anchor-link"></span>Keeping the Switch Alive Using the Hardware Watchdog</span>
