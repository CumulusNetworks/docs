...
The *cumulus* account:
  ...
  - 
    ...
    <div id="src-5866105_indexterm-0D44F1077870D496CBCEEB25499E5A05">
  ...
  - User can log in to the system via all the usual channels like
    console and
    [SSH](/version/cumulus-linux-330/System-Configuration/Authentication-Authorization-and-Accounting/SSH-for-Remote-Access)
...
commands](/version/cumulus-linux-330/System-Configuration/Authentication-Authorization-and-Accounting/Using-sudo-to-Delegate-Privileges),
so be sure to include them in the *sudo* group.

To access the switch without any password requires [booting into a
single shell/user
mode](/version/cumulus-linux-330/Monitoring-and-Troubleshooting/Single-User-Mode-Boot-Recovery).
...
### <span id="src-5866105_UserAccounts-ssh_key" class="confluence-anchor-link"></span>Generating an SSH Key for the root Account</span>
...
### <span id="src-5866105_UserAccounts-root_passwd" class="confluence-anchor-link"></span>Setting the root User Password</span>
