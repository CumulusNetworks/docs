...
## Supported Features
  ...
  - Forwarding path failure detection using 
    [Bidirectional Forwarding Detection](http://tools.ietf.org/html/rfc5880) (BFD); however,
    demand mode is not supported. For more information on how BFD
    operates in Cumulus Linux, read the 
    [Bidirectional Forwarding Detection - BFD](/version/cumulus-linux-332/Layer-Three/Bidirectional-Forwarding-Detection-BFD)
...
[BFD chapter](/version/cumulus-linux-332/Layer-Three/Bidirectional-Forwarding-Detection-BFD).
