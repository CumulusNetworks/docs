...
1.  Enable the BGP and Zebra daemons, `zebra` and `bgpd`, then enable
    ...
    Quagga](/cumulus-linux-332/Layer-Three/Configuring-Quagga/).
...
[peer group](#using-peer-groups-to-simplify-configuration)
...
(`net add interface <interface> ipv6 nd ra-interval <interval>`) 
to address scenarios when
...
`bgp listen range <IP address> peer-group <GROUP>` command. Once they are 
configured, a BGP speaker can
...
using [management VRF](/cumulus-linux-332/Layer-Three/Management-VRF) 
...
[Virtual Routing and Forwarding - VRF](/cumulus-linux-332/Layer-Three/Virtual-Routing-and-Forwarding-VRF).
...
For more information about ACLs, see [Netfilter (ACLs)](/cumulus-linux-332/System-Configuration/Netfilter-ACLs/).

{{%/notice%}}

### Related Information

  - [Bidirectional forwarding detection](/cumulus-linux-332/Layer-Three/Bidirectional-Forwarding-Detection-BFD)
    (BFD) and BGP
