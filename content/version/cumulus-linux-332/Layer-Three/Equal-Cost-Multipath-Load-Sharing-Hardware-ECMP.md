...
[ECMP section](/version/cumulus-linux-332/Layer-Three/Border-Gateway-Protocol-BGP/#ecmp-with-bgp)
...
3.  [Restart](/version/cumulus-linux-332/System-Configuration/Configuring-switchd/#restarting-switchd)
    the `switchd` service:
