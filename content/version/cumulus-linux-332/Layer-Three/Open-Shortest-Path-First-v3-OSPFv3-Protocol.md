...
---
OSPFv3 is a revised version of OSPFv2 to support the IPv6 address family. Refer to
[Open Shortest Path First (OSPF) Protocol](/version/cumulus-linux-332/Layer-Three/Open-Shortest-Path-First-OSPF-Protocol)
...
[Quagga](/version/cumulus-linux-332/Layer-Three/Quagga-Overview) does
not support it yet.
...
1.  Enabling the `zebra` and `ospf6` daemons, as described in
    [Configuring Quagga](/version/cumulus-linux-332/Layer-Three/Configuring-Quagga/)
...
See [Debugging OSPF](/version/cumulus-linux-332/Layer-Three/Open-Shortest-Path-First-OSPF-Protocol/#debugging-ospf)
