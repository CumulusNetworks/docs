...
### Configuring the agentAddress</span>
...
### <span id="src-5868926_SNMPMonitoring-public_community" class="confluence-anchor-link"></span>Setting the Community String</span>
...
### <span id="src-5868926_SNMPMonitoring-quagga" class="confluence-anchor-link"></span>Enabling SNMP Support for Quagga</span>

As of Cumulus Linux 3.3.1, SNMP is now supported for
[Quagga](/version/cumulus-linux-332/Layer-Three/Quagga-Overview). To
...
<tr class="odd">
<td><p><strong><a href="/version/cumulus-linux-332/Monitoring-and-Troubleshooting/SNMP-Monitoring/Using-Nutanix-Prism-as-a-Monitoring-Tool">Nutanix Prism CLI</a></strong> (SSH to the cluster IP address)</p></td>
...
## <span id="src-5868926_SNMPMonitoring-supported_mibs" class="confluence-anchor-link"></span>Supported MIBs</span>
...
<td><p>L2 neighbor info from <code>lldpd</code> (note, you need to <a href="Link-Layer-Discovery-Protocol.html#src-5868965_LinkLayerDiscoveryProtocol-snmp">enable the SNMP subagent</a> in LLDP). <code>lldpd</code> needs to be started with the <code>-x</code> option to enable connectivity to <code>snmpd</code> (AgentX).</p></td>
</tr>
<tr class="even">
