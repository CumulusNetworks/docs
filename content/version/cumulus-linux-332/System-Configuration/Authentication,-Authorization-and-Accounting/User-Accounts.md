...
The *cumulus* account:
  ...
  - 
    ...
    <div id="src-5868877_indexterm-4B4DD4384E57F0D7C4532B2AEC9F3896">
...
commands](/version/cumulus-linux-332/System-Configuration/Authentication-Authorization-and-Accounting/Using-sudo-to-Delegate-Privileges),
so be sure to include them in the *sudo* group.

To access the switch without any password requires [booting into a
single shell/user
mode](/version/cumulus-linux-332/Monitoring-and-Troubleshooting/Single-User-Mode-Boot-Recovery).
...
### <span id="src-5868877_UserAccounts-ssh_key" class="confluence-anchor-link"></span>Generating an SSH Key for the root Account</span>
...
### <span id="src-5868877_UserAccounts-root_passwd" class="confluence-anchor-link"></span>Setting the root User Password</span>
