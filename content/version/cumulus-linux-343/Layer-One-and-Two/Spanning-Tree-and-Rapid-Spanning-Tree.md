...
[traditional or VLAN-aware bridge driver mode](/version/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/)
is in use.
...
For a bridge in [traditional mode](/version/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/),
...
asterisk (\*). You can 
[edit the blacklist](/version/cumulus-linux-343/System-Configuration/Network-Command-Line-Utility-NCLU/#advanced-configuration)
...
<p>{{%notice note%}}</p>
<p>This setting only applies to a bridge in <a href="/version/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges">traditional mode</a>; it does not apply to <a href="/version/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments">VLAN-aware bridges</a>.</p>
<p>{{%/notice%}}</p></td>
</tr>
<tr class="even">
