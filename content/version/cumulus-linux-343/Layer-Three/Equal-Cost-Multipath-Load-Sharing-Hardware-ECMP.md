...
[ECMP section](/version/cumulus-linux-343/Layer-Three/Border-Gateway-Protocol-BGP/#ecmp-with-bgp)
...
[Spectrum, Tomahawk, Trident II+ and Trident II](http://cumulusnetworks.com/hcl/)
chipsets.
...
[Broadcom Tomahawk, Trident II+ and Trident II as well as Mellanox Spectrum](http://cumulusnetworks.com/hcl/)
chipsets. You can run `net show system` to determine the chipset.
...
3. [Restart](/version/cumulus-linux-343/System-Configuration/Configuring-switchd/#restarting-switchd)
    the `switchd` service:
