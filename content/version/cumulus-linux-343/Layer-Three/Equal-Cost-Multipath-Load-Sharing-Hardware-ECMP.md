...
section](Border-Gateway-Protocol-BGP.html#src-7112665_BorderGatewayProtocol-BGP-ecmp)
...
3.  [Restart](Configuring-switchd.html#src-7112319_Configuringswitchd-restartswitchd)
    the `switchd` service:
