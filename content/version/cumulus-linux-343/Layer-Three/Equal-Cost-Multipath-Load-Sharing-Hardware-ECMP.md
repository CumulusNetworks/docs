...
[ECMP section](/cumulus-linux-343/Layer-Three/Border-Gateway-Protocol-BGP/#ecmp-with-bgp)
...
3. [Restart](/cumulus-linux-343/System-Configuration/Configuring-switchd/#restarting-switchd)
    the `switchd` service:
