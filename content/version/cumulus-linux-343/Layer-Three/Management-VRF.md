...
To enable management VRF on eth0, complete the following steps. The example
NCLU commands below create a VRF called *mgmt*:
...
[agentAddress](/cumulus-linux-343/Monitoring-and-Troubleshooting/SNMP-Monitoring/#configuring-the-agentaddress).
...
[here](/cumulus-linux-343/Interface-Configuration-and-Management/Configuring-DHCP-Relays/#configuring-multiple-dhcp-relays))
and `hsflowd` (discussed [below](#enabling-hsflowd)).
...
If you are using
[sFlow](/cumulus-linux-343/Monitoring-and-Troubleshooting/Network-Troubleshooting/Monitoring-System-Statistics-and-Network-Traffic-with-sFlow/)
...
In `ifupdown2`, [interface classes](/cumulus-linux-343/Interface-Configuration-and-Management/#ifupdown2-interface-classes)
