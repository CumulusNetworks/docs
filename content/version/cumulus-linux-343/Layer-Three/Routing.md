...
A static route can also be created by adding 
`post-up ip route add` command to a switch port configuration. For example:
...
You can use
[`cl-resource-query`](/cumulus-linux-343/Monitoring-and-Troubleshooting/Resource-Diagnostics-Using-cl-resource-query)
...
After you specify a different profile, [restart `switchd`](/cumulus-linux-343/System-Configuration/Configuring-switchd/#restarting-switchd)
...
When [nonatomic updates](/cumulus-linux-343/System-Configuration/Netfilter-ACLs/#enabling-nonatomic-update-mode) 
...
- [FRRouting docs - static route commands](https://frrouting.org/user-guide/Static-Route-Commands.html#Static-Route-Commands)
