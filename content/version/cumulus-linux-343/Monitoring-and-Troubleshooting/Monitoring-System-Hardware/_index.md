...
You monitor system hardware in these ways, using:
  ...
  - [Net-SNMP](/version/cumulus-linux-343/Monitoring-and-Troubleshooting/SNMP-Monitoring/)
...
## <span id="src-7112351_MonitoringSystemHardware-snmp" class="confluence-anchor-link"></span>Monitoring Switch Hardware Using SNMP</span>

The Net-SNMP documentation is discussed
[here](/version/cumulus-linux-343/Monitoring-and-Troubleshooting/SNMP-Monitoring/).

## <span id="src-7112351_MonitoringSystemHardware-smond" class="confluence-anchor-link"></span>Monitoring System Units Using smond</span>
...
## <span id="src-7112351_MonitoringSystemHardware-watchdog" class="confluence-anchor-link"></span>Keeping the Switch Alive Using the Hardware Watchdog</span>
