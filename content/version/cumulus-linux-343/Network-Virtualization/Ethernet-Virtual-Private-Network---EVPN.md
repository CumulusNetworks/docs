...
HER is enabled by default, as it is when [Lightweight Network Virtualization (LNV)](/version/cumulus-linux-34/Network-Virtualization/Lightweight-Network-Virtualization-Overview/)
is used.
