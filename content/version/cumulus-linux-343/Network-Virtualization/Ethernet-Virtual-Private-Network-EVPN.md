...
[VXLANs](/cumulus-linux-343/Network-Virtualization/) in Cumulus
...
- Support for dual-attached hosts via 
  [VXLAN active-active mode](/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode);
...
FRR, refer to the [FRR Overview](/cumulus-linux-343/Layer-Three/FRRouting-Overview/).
...
mode](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges),
you must edit the bridge configuration in the `/etc/network/interfaces`
file in a text editor:
...
For a bridge in [traditional mode](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges),
you must edit the bridge configuration in the `/etc/network/interfaces`
file in a text editor:
...
[Head End Replication (HER)](/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/#head-end-replication).
HER is enabled by default, as it is when 
[Lightweight Network Virtualization (LNV)](/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/)
is used.
...
- The `clagd-vxlan-anycast-ip` parameter must be under the 
  [loopback stanza](/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode/#active-active-vtep-anycast-ip-behavior)
  on both peers
- The anycast address should be advertised to the routed fabric from
  both peers
- The
  [VNIs](/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode/#example-vxlan-active-active-configuration)
  must be configured identically on both peers
- The
  [peerlink](/cumulus-linux-343/Network-Virtualization/Lightweight-Network-Virtualization-LNV-Overview/LNV-VXLAN-Active-Active-Mode/#example-vxlan-active-active-configuration)
