...
3.  [Restart `switchd`](/cumulus-linux-343/System-Configuration/Configuring-switchd/#restarting-switchd):
...
interfaces on both
[VLAN-aware](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments)
and [traditional mode](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/Traditional-Mode-Bridges)
bridges, including bridge SVIs ([switch VLAN interfaces](/cumulus-linux-343/Layer-One-and-Two/Ethernet-Bridging-VLANs/#configuring-an-svi-switch-vlan-interface))
...
with the [TCAM profile](/cumulus-linux-343/Layer-Three/Routing/#tcam-resource-profiles-for-mellanox-switches) specified
for the switch.
...
Then [restart `switchd`](/cumulus-linux-343/System-Configuration/Configuring-switchd/#restarting-switchd).
