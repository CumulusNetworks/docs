...
[restart the `switchd`](/cumulus-linux-35/System-Configuration/Configuring-switchd/#restarting-switchd)
service.
...
If you modify the configuration in the `/etc/cumulus/datapath/traffic.conf` file, you must 
...
[IEEE 802.1Qbb standard](http://www.ieee802.org/1/pages/802.1bb.html), provides 
a link-level flow control mechanism that can be controlled independently
