...
## <span id="src-8357452_TraditionalModeBridges-VLAN_tagging" class="confluence-anchor-link"></span>Using Trunks in Traditional Bridge Mode</span>
...
chapter](/version/cumulus-linux-35/Layer-1-and-2/Ethernet-Bridging-VLANs/VLAN-Tagging).

### <span id="src-8357452_TraditionalModeBridges-arp" class="confluence-anchor-link"></span>Configuring ARP Timers</span>
