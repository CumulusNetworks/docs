...
When you configure [Management VRF](/cumulus-linux-35/Layer-3/Management-VRF/), you
...
[FRRouting](/cumulus-linux-35/Layer-3/FRRouting-Overview/). To
...
<tr class="odd">
<td><p><strong><a href="/cumulus-linux-35/Monitoring-and-Troubleshooting/SNMP-Monitoring/Using-Nutanix-Prism-as-a-Monitoring-Tool">Nutanix Prism CLI</a></strong> (SSH to the cluster IP address)</p></td>
...
<td><p>L2 neighbor info from <code>lldpd</code> (note, you need to <a href="/cumulus-linux-35/Layer-1-and-2/Link-Layer-Discovery-Protocol/#enabling-the-snmp-subagent-in-lldp">enable the SNMP subagent</a> in LLDP). <code>lldpd</code> needs to be started with the <code>-x</code> option to enable connectivity to <code>snmpd</code> (AgentX).</p></td>
</tr>
<tr class="even">
...
`bgp4_pp.py` and `cl_poe_pp.py` scripts:
  ...
  - `cl_poe_pp.py` is disabled by default as only some platforms that
    ...
    [Power over Ethernet](/cumulus-linux-35/System-Configuration/Power-over-Ethernet-PoE).
## Troubleshooting
