...
[Spanning
Tree](/version/cumulus-linux-36/Layer-2/Spanning-Tree-and-Rapid-Spanning-Tree).
...
### <span id="src-8362164_VLAN-awareBridgeMode-svi" class="confluence-anchor-link"></span>VLAN Layer 3 Addressing — Switch Virtual Interfaces and Other VLAN Attributes </span>
...
### <span id="src-8362164_VLAN-awareBridgeMode-arp" class="confluence-anchor-link"></span>Configuring ARP Timers</span>
...
### <span id="src-8362164_VLAN-awareBridgeMode-glob" class="confluence-anchor-link"></span>Configuring Multiple Ports in a Range</span>
...
### <span id="src-8362164_VLAN-awareBridgeMode-vlan_range" class="confluence-anchor-link"></span>Reserved VLAN Range</span>
