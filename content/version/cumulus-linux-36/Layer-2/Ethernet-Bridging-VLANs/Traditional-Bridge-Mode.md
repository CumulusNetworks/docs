...
2. Add a new stanza to create the bridge, and save the file. The
    ...
    |bridge-stp|Enables spanning tree protocol on this bridge. The default spanning tree mode is Per VLAN Rapid Spanning Tree Protocol (PVRST).<br />For more information on spanning-tree configurations see [Spanning Tree and Rapid Spanning Tree](/version/cumulus-linux-36/Layer-2/Spanning-Tree-and-Rapid-Spanning-Tree).|off|
...
{{< img src = "https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/cumulus-linux/multiple-bridges.png" >}}
