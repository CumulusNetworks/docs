...
Keep in the mind the following caveats with all-active mode:
  ...
  - Spanning tree protocol (STP) does not run on the individual bond
    ...
    [STP BPDU guard](/version/cumulus-linux-36/Layer-2/Spanning-Tree-and-Rapid-Spanning-Tree/#bpdu-guard)
...
In an [MLAG deployment](/version/cumulus-linux-36/Layer-2/Multi-Chassis-Link-Aggregation-MLAG)
...
[traditional bridge mode](/version/cumulus-linux-36/Layer-2/Ethernet-Bridging-VLANs/Traditional-Bridge-Mode):
