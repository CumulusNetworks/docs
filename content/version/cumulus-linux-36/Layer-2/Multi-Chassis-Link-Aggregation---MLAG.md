...
## <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-reqs" class="confluence-anchor-link"></span>MLAG Requirements</span>
...
MLAG has these requirements:
  ...
  - The dual-connected devices (servers or switches) can use LACP (IEEE
    ...
    [balance-xor
    mode](Bonding-Link-Aggregation.html#src-8362148_Bonding-LinkAggregation-balance_xor)
...
## <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-configuring" class="confluence-anchor-link"></span>Configuring MLAG</span>
...
unnumbered](/version/cumulus-linux-36/Layer-3/Border-Gateway-Protocol-BGP)
interfaces.

{{%/notice%}}

### <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-roles" class="confluence-anchor-link"></span>Understanding Switch Roles and Setting Priority</span>
...
## <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-example" class="confluence-anchor-link"></span>Example MLAG Configuration</span>
...
use](VLAN-aware-Bridge-Mode-for-Large-scale-Layer-2-Environments.html#src-8362167_VLAN-awareBridgeModeforLarge-scaleLayer2Environments-range).
...
[untagged/native](/version/cumulus-linux-36/Layer-2/Ethernet-Bridging-VLANs/Traditional-Bridge-Mode)
...
## <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-protodown" class="confluence-anchor-link"></span>Peer Link Interfaces and the protodown State</span>
...
### <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-backup" class="confluence-anchor-link"></span>Specifying a Backup Link</span>
...
#### <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-vrf_backup" class="confluence-anchor-link"></span>Specifying a Backup Link to a VRF</span>

You can configure the backup link to a
[VRF](/version/cumulus-linux-36/Layer-3/Virtual-Routing-and-Forwarding-VRF)
or [management VRF](/version/cumulus-linux-36/Layer-3/Management-VRF).
...
[IGMP snooping](/version/cumulus-linux-36/Layer-2/IGMP-and-MLD-Snooping)
...
Snooping](/version/cumulus-linux-36/Layer-2/IGMP-and-MLD-Snooping)
chapter.
...
### <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-mtu" class="confluence-anchor-link"></span>Understanding MTU in an MLAG Configuration</span>

The
[MTU](/version/cumulus-linux-36/Layer-1-and-Switch-Ports/Interface-Configuration-and-Management/Switch-Port-Attributes)
...
`mtu 9216`](/version/cumulus-linux-36/Layer-1-and-Switch-Ports/Interface-Configuration-and-Management/Switch-Port-Attributes)
...
Assurance](Spanning-Tree-and-Rapid-Spanning-Tree.html#src-8362181_SpanningTreeandRapidSpanningTree-bpdu).
...
### <span id="src-8362169_Multi-ChassisLinkAggregation-MLAG-drops" class="confluence-anchor-link"></span>Large Packet Drops on the Peerlink Interface</span>
