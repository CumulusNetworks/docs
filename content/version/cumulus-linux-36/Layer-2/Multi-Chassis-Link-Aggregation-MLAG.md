...
If for some reason you cannot use LACP, you can also use
    [balance-xor mode](/version/cumulus-linux-36/Layer-2/Bonding-Link-Aggregation/#enabling-balance-xor-mode)
...
[BGP unnumbered](/version/cumulus-linux-36/Layer-3/Border-Gateway-Protocol-BGP/#using-bgp-unnumbered-interfaces)
interfaces.
...
[range of VLAN IDs you can use](/version/cumulus-linux-36/Layer-2/Ethernet-Bridging-VLANs/VLAN-aware-Bridge-Mode/#reserved-vlan-range).
...
[IGMP and MLD Snooping](/version/cumulus-linux-36/Layer-2/IGMP-and-MLD-Snooping)
chapter.
...
[BPDU Guard](/version/cumulus-linux-36/Layer-2/Spanning-Tree-and-Rapid-Spanning-Tree/#bpdu-guard).
