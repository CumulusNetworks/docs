...
family. Refer to 
[Open Shortest Path First (OSPF) Protocol](/version/cumulus-linux-36/Layer-3/Open-Shortest-Path-First-OSPF-Protocol)
...
[FRR](/version/cumulus-linux-36/Layer-3/FRRouting-Overview/) does not
support it yet.
...
1.  Enabling the `zebra` and `ospf6` daemons, as described in
    [Configuring FRRouting](/version/cumulus-linux-36/Layer-3/Configuring-FRRouting/)
...
See [Debugging OSPF](/version/cumulus-linux-36/Layer-3/Open-Shortest-Path-First-OSPF-Protocol/#span-id-src-8362392-openshortestpathfirst-ospf-protocol-ospf-debug-class-confluence-anchor-link-debugging-ospf)
...
## Related Information
  ...
  - [Auto-cost reference bandwidth](/version/cumulus-linux-36/Layer-3/Open-Shortest-Path-First-OSPF-Protocol/#auto-cost-reference-bandwidth)
    (OSPFv2 chapter)
