...
[ifplugd](/version/cumulus-linux-36/Layer-2/Virtual-Router-Redundancy-VRR/ifplugd).
...
## Troubleshooting
  ...
  - **What is table 10? Why was table 10 chosen?**  
    ...
    or you can read the [Ubuntu man pages for `ip route`](http://manpages.ubuntu.com/manpages/quantal/man8/ip-route.8.html).
