...
Not all switch models include a sensor for monitoring power consumption and 
voltage. See 
[this note](/version/cumulus-linux-36/Monitoring-and-Troubleshooting/Monitoring-System-Hardware/#monitoring-system-units-using-smond)
for details.
...
PTM. For more information, refer to the [Prescriptive Topology Manager documentation](/version/cumulus-linux-36/Layer-1-and-Switch-Ports/Prescriptive-Topology-Manager-PTM/).
