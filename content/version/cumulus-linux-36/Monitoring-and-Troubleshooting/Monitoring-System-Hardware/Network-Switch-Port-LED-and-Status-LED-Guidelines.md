...
weight: 449
aliases:
 - /display/CL36/Network+Switch+Port+LED+and+Status+LED+Guidelines
 - /pages/viewpage.action?pageId=8362090
pageID: 8362090
...
A network port LED indicates the state of the link, for example, link UP, Tx/Rx
or activity. Here are the requirements for these LEDs:
