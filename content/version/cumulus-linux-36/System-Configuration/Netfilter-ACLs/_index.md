...
3.  [Restart `switchd`](/version/cumulus-linux-36/System-Configuration/Configuring-switchd/#restarting-switchd):
...
and [traditional mode](/version/cumulus-linux-36/Layer-2/Ethernet-Bridging-VLANs/Traditional-Bridge-Mode)
bridges, including bridge SVIs 
([switch VLAN interfaces](/version/cumulus-linux-36/Layer-2/Ethernet-Bridging-VLANs/#configuring-an-svi-switch-vlan-interface))
...
[TCAM profile](/version/cumulus-linux-36/Layer-3/Routing/#tcam-resource-profiles-for-mellanox-switches) specified for the
switch.
...
then [restart `switchd`](/version/cumulus-linux-36/System-Configuration/Configuring-switchd/#restarting-switchd).
