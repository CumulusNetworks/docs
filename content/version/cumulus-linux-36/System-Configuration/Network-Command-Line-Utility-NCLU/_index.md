...
configuration with the following commands:
  ...
  - `net commit permanent` retains the
    [snapshot](/version/cumulus-linux-36/Installation-Management/Using-Snapshots)
...
[TACACS](/version/cumulus-linux-36/System-Configuration/Authentication-Authorization-and-Accounting/TACACS-Plus)
or
[RADIUS](/version/cumulus-linux-36/System-Configuration/Authentication-Authorization-and-Accounting/RADIUS-AAA)
account name.
...
[*tacacs* group](/version/cumulus-linux-36/System-Configuration/Authentication-Authorization-and-Accounting/TACACS-Plus/#configuring-nclu-for-tacacs-users).
