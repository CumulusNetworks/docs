...
weight: 49
aliases:
 - /display/CL40/Zero-Touch-Provisioning---ZTP
 - /pages/viewpage.action?pageId=8366353
pageID: 8366353
...
3.  The contents of the script are parsed to ensure it contains the
    ...
    scripts](#src-8366353_ZeroTouchProvisioning-ZTP-example_scripts)).
...
4.  The zero touch provisioning process requests the contents of the
    ...
    headers](#src-8366353_ZeroTouchProvisioning-ZTP-http_headers)
...
### <span id="src-8366353_ZeroTouchProvisioning-ZTP-http_headers" class="confluence-anchor-link"></span><span>Inspect HTTP Headers</span>
...
<span id="src-8366353_ZeroTouchProvisioning-ZTP-example_scripts"></span>The
