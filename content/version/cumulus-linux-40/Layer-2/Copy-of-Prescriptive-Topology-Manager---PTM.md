...
weight: 131
aliases:
 - /display/CL40/Copy-of-Prescriptive-Topology-Manager---PTM
 - /pages/viewpage.action?pageId=8366424
pageID: 8366424
...
## <span>Supported Features</span>
  ...
  - Forwarding path failure detection using [Bidirectional Forwarding
    ...
    below](#src-8366424_CopyofPrescriptiveTopologyManager-PTM-bfd) and
    see `man ptmd(8)`.
  ...
  - User configuration via a `topology.dot` file; [see
    below](#src-8366424_CopyofPrescriptiveTopologyManager-PTM-configuring).

## <span id="src-8366424_CopyofPrescriptiveTopologyManager-PTM-configuring" class="confluence-anchor-link"></span><span>Configure PTM</span>
...
## <span id="src-8366424_CopyofPrescriptiveTopologyManager-PTM-example" class="confluence-anchor-link"></span><span>Basic Topology Example</span>
...
## <span id="src-8366424_CopyofPrescriptiveTopologyManager-PTM-advanced" class="confluence-anchor-link"></span><span>Advanced PTM Configuration</span>
...
below](#src-8366424_CopyofPrescriptiveTopologyManager-PTM-ptmd_commands).
...
### <span id="src-8366424_CopyofPrescriptiveTopologyManager-PTM-bfd" class="confluence-anchor-link"></span><span>Bidirectional Forwarding Detection (BFD)</span>
...
chapter](/version/cumulus-linux-40/Layer-3/Bidirectional-Forwarding-Detection---BFD).
...
that file. Use
[Quagga](/version/cumulus-linux-40/Layer-3/Configuring-FRRouting/) to
...
[Quagga](/version/cumulus-linux-40/Layer-3/Bidirectional-Forwarding-Detection---BFD).
...
## <span id="src-8366424_CopyofPrescriptiveTopologyManager-PTM-quagga" class="confluence-anchor-link"></span><span>Enable Quagga to Check Link State</span>
...
## <span id="src-8366424_CopyofPrescriptiveTopologyManager-PTM-ptmd_commands" class="confluence-anchor-link"></span><span>ptmd Service Commands</span>
