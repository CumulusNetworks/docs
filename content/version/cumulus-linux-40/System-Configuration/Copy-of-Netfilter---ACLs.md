...
weight: 77
aliases:
 - /display/CL40/Copy-of-Netfilter---ACLs
 - /pages/viewpage.action?pageId=8366305
pageID: 8366305
...
{{% imgOld 5 %}}
  ...
  - **Target(s):** The *target* can be a user-defined chain (other than
    ...
    Usages](#src-8366305_CopyofNetfilter-ACLs-supported) section below
...
### <span id="src-8366305_CopyofNetfilter-ACLs-nonatomic" class="confluence-anchor-link"></span><span>Enable Nonatomic Updates</span>
...
### <span>Use iptables/ip6tables/ebtables Directly</span>
...
### <span>Estimate the Number of Rules</span>
...
### <span>Match SVI/Bridged Interfaces in Rules</span>
...
listed [later in this chapter](#src-8366305_CopyofNetfilter-ACLs-exm).
...
function of the following factors:
  ...
  - Whether the rules are in atomic or nonatomic mode; nonatomic mode
    ...
    above](#src-8366305_CopyofNetfilter-ACLs-nonatomic))
...
with the [TCAM profile](Routing.html#src-8366636_Routing-tcam) specified
for the switch.
...
## <span id="src-8366305_CopyofNetfilter-ACLs-supported" class="confluence-anchor-link"></span><span>Supported Rule Types</span>
...
<li><p>IP common: tcp (<a href="#src-8366305_CopyofNetfilter-ACLs-filteringtcp">with flags</a>), udp, multiport,TOS, DSCP, addrtype</p></li>
</ul></td>
<td><ul>
...
### <span id="src-8366305_CopyofNetfilter-ACLs-filteringtcp" class="confluence-anchor-link"></span><span>Filter Specific TCP Flags</span>
...
<span id="src-8366305_CopyofNetfilter-ACLs-examples"></span>The
...
section](#src-8366305_CopyofNetfilter-ACLs-supported) above, not all
...
### <span>Trident II+ and Trident3 Hardware Limitations</span>
