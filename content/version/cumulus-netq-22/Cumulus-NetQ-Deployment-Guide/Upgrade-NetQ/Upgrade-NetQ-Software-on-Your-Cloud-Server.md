...
5.  Scroll down to review the images that match your selection
  criteria.
      ...
      {{< figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/netq/netq-22-vm-cloud-upgrade-222.png" width="400" >}}
...
3.  Continue the NetQ upgrade by upgrading the NetQ Agent on each switch or host you want to monitor. Refer to [Install the NetQ Agent and CLI on Switches](../../Install-NetQ/Install-NetQ-Agents-and-CLI-on-Switches/) for instructions.
