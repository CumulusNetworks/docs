...
For network-wide monitoring, refer to [Monitor Network Performance](../../Monitor-Network-Performance/).
...
<tr class="odd">
<td><p>Score</p></td>
<td><p>When selected, displays count of alarms generated by network services, interfaces, system and trace on this switch, the total alarm count, and an overall health value (average of all alarm counts) during the designated time period</p></td>
</tr>
<tr class="even">
<td><p>Charts</p></td>
<td><p>When selected, displays distribution of overall health score for network services, interfaces, system and trace performance on this switch, as well as total alarm count, during the designated time period</p></td>
</tr>
</tbody>
</table>
