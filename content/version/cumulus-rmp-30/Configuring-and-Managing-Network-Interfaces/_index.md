...
Attributes](/cumulus-rmp-30/Configuring-and-Managing-Network-Interfaces/Layer-1-and-Switch-Port-Attributes).
...
## <span id="src-5118733_ConfiguringandManagingNetworkInterfaces-classes" class="confluence-anchor-link"></span>ifupdown2 Interface Classes</span>
...
link speed, and so
forth](/cumulus-rmp-30/Configuring-and-Managing-Network-Interfaces/Layer-1-and-Switch-Port-Attributes).
...
Interface descriptions also appear in the [SNMP OID](/cumulus-rmp-30/Monitoring-and-Troubleshooting/Monitoring-System-Hardware/#span-idsrc-5118690-monitoringsystemhardware-snmp-classconfluence-anchor-linkspanmonitoring-switch-hardware-using-snmpspan)
