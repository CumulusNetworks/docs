...
mode](/cumulus-rmp-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/)
is in use.
...
be found
here](/cumulus-rmp-31/Layer-1-and-Layer-2-Features/Ethernet-Bridging-VLANs/).
...
You configure storm control for each physical port in one of three ways:
  ...
  - By editing `/etc/cumulus/switchd.conf`. The configuration persists
    ...
    must [restart `switchd`](/cumulus-rmp-31/System-Management/Configuring-switchd/#restarting-switchdspan)
  ...
  - By writing directly to the [`switchd` filesystem](/cumulus-rmp-31/System-Management/Configuring-switchd/#the-switchd-file-systemspan).
