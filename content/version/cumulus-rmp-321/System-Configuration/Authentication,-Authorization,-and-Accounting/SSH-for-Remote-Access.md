...
switch unless you [generate an SSH key](/cumulus-rmp-321/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/#span-id-src-5127540-useraccounts-ssh-key-class-confluence-anchor-link-span-generating-an-ssh-key-for-the-root-account-span) or [set a password](/cumulus-rmp-321/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/#span-id-src-5127540-useraccounts-root-passwd-class-confluence-anchor-link-span-setting-the-root-user-password-span) for
the account.
