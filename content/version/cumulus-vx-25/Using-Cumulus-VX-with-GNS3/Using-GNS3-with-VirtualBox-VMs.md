...
4.  From the left pane, select **VirtualBox VMs**, then click **New**.
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/cumulus-vx/VX_GNS3_new_VBox_VM.png">}}
...
5.  From the **VM list**, select the VM that you want to run in GNS3,
    ...
    {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/cumulus-vx/VX_GNS3_VBox_VMs.png">}}
...
6.  Enable GNS3 to work with the VirtualBox VMs’ network interfaces.
    Configure each VM's network settings, using the GNS3 interface:
      ...
      - In the VirtualBox VM configuration dialog, click the **Network**
        ...
        {{<figure src="https://s3-us-west-2.amazonaws.com/dev.docs.cumulusnetworks.com/images/cumulus-vx/VX_GNS3_VBox_VM_nwconfig.png">}}
