...
def get_products():
    ...
    cl_exclude_list = ["3.7.12", "4.1.0", "4.1.1", "4.2.0", "4.3.0", "4.3.1", "4.4.0", "4.4.2", "4.4.3", "4.4.4", "4.4.5", "5.0.1", "5.1.0", "5.2.0", "5.3.0", "5.3.1", "5.4.0"]
    netq_exclude_list = ["4.1.0", "4.2.0", "4.3.0", "4.4.0", "4.5.0"]
