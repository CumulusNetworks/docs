...
def get_products():
    ...
    cl_exclude_list = ["3.7.12", "4.1.0", "4.1.1", "4.2.0", "4.3.0", "4.3.1", "4.3.2", "4.3.3", "4.3.4", "4.4.0", "4.4.1", "4.4.1", "4.4.2", "4.4.3", "4.4.4", "4.4.5", "5.0.1", "5.1.0", "5.2.0", "5.3.0", "5.3.1", "5.4.0", "5.5.0", "5.5.1", "5.6.0", "5.7.0", "5.8.0", "5.9.0", "5.9.1", "5.9.2", "5.9.3", "5.9.4", "5.9.5", "5.10.0", "5.10.1", "5.11.0", "5.11.1", "5.11.2", "5.11.3", "5.11.4", "5.11.5", "5.12.0", "5.12.1", "5.13.0", "5.14.0", "5.15.0", "5.15.1", "5.15.2", "5.16.0", "5.16.1", "5.16.2", "5.17.0"]
    netq_exclude_list = ["4.1.0", "4.2.0", "4.3.0", "4.4.0", "4.5.0", "4.6.0", "4.7.0", "4.8.0", "4.9.0", "4.10.0", "4.10.1", "4.11.0", "4.12.0", "4.13.0", "4.14.0", "4.15.0", "5.0.0", "5.0.1", "5.1.0", "5.2.0", "5.2.1", "5.3.0"]
